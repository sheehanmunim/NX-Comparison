...
class DataManager(Utilities.NXRemotableObject):
    ...
    def LoadFile(self, fileName: str) -> None:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.LoadFile instead when loading an AFU file; Use CAE.FTK.Op2FileManager.LoadFile instead when loading an OP2 file.")"""
        ...
    def UnloadFile(self, fileName: str) -> None:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.UnloadFile instead when unloading an AFU file; Use CAE.FTK.Op2FileManager.UnloadFile instead when unloading an OP2 file.")"""
        ...
    def LoadFile(self, fileName: str, containerType: CAE.FTK.DataManager.FileContainerType) -> None:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.LoadFile instead when loading an AFU file; Use CAE.FTK.Op2FileManager.LoadFile instead when loading an OP2 file.")"""
        ...
    def UnloadFile(self, fileName: str, containerType: CAE.FTK.DataManager.FileContainerType) -> None:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.UnloadFile instead when unloading an AFU file; Use CAE.FTK.Op2FileManager.UnloadFile instead when unloading an OP2 file.")"""
        ...
    def DeleteFile(self, fileName: str) -> None:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.DeleteFile instead when deleting an AFU file; Use CAE.FTK.Op2FileManager.DeleteFile instead when deleting an OP2 file.")"""
        ...
    def GetAfuRecord(self, afuFileName: str, recordName: str) -> CAE.FTK.BaseRecord:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.AfuFileManager.GetRecord instead")"""
        ...
    def GetOp2Record(self, op2FileName: str, dataSetName: str, recordName: str) -> CAE.FTK.BaseRecord:
        """[Obsolete("Deprecated in NX12.0.1.  Use CAE.FTK.Op2FileManager.GetRecord instead")"""
        ...
    ...
    def CreateArrayUnit(self, nxUnit: Unit) -> CAE.FTK.BaseUnit:
        ...
    def CreateArrayRecordUnit(self, unitType: CAE.XyFunctionUnit) -> CAE.FTK.BaseUnit:
        """[Obsolete("Deprecated in NX12.0.0.  Use NXOpen.CAE.FTK.DataManager.CreateArrayUnit instead.")"""
        ...
    def CreateArrayUnit(self, measureType: CAE.XyFunctionMeasure, unitType: CAE.XyFunctionUnit) -> CAE.FTK.BaseUnit:
        """[Obsolete("Deprecated in NX11.0.0.  Use NXOpen.CAE.FTK.DataManager.CreateArrayUnit instead.")"""
        ...
    def CreateArrayUnit(self, nxUnit: Unit, aliasMeasureName: str) -> CAE.FTK.BaseUnit:
        ...
    def CreateUnitlessUnit(self, unitName: str) -> CAE.FTK.BaseUnit:
        ...
