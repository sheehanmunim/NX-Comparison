...
class CurveAnalysisPeaksBuilder(Builder):
    def __init__(self) -> None: ...
    def CreatePoints(self) -> typing.List[Point]:
        """[Obsolete("Deprecated in NX8.5.0.  Use GeometricAnalysis.CurveCurvatureAnalysis..")"""
        ...
    DirectionOption: GeometricAnalysis.CurveAnalysisPeaksBuilder.DirectionOptionType
    SelectedCurves: ScCollector
    Vector: Direction
...
class CurveAnalysisInflectionsBuilder(Builder):
    def __init__(self) -> None: ...
    def CreatePoints(self) -> typing.List[Point]:
        """[Obsolete("Deprecated in NX8.5.0.  Use GeometricAnalysis.CurveCurvatureAnalysisBuilder..")"""
        ...
    DirectionOption: GeometricAnalysis.CurveAnalysisInflectionsBuilder.DirectionOptionType
    SelectedCurves: ScCollector
    Vector: Direction
...
class CurveAnalysisCombsBuilder(Builder):
    def __init__(self) -> None: ...
    ...
    DirectionOption: GeometricAnalysis.CurveAnalysisCombsBuilder.DirectionOptionType
    SelectedCurves: ScCollector
    Vector: Direction
...
class AnalysisObjectCollection(TaggedObjectCollection):
    ...
    def CreateCurveCurvatureAnalysisBuilder(self, caaoObject: DisplayableObject) -> GeometricAnalysis.CurveCurvatureAnalysisBuilder:
        ...
    def CreateCurveAnalysisCombsBuilder(self) -> GeometricAnalysis.CurveAnalysisCombsBuilder:
        """[Obsolete("Deprecated in NX8.5.0.  Use NXOpen.GeometricAnalysis.CurveCurvatureAnalysis.")"""
        ...
    def CreateCurveAnalysisInflectionsBuilder(self) -> GeometricAnalysis.CurveAnalysisInflectionsBuilder:
        """[Obsolete("Deprecated in NX8.5.0.  Use NXOpen.GeometricAnalysis.CurveCurvatureAnalysis.")"""
        ...
    def CreateCurveAnalysisPeaksBuilder(self) -> GeometricAnalysis.CurveAnalysisPeaksBuilder:
        """[Obsolete("Deprecated in NX8.5.0.  Use NXOpen.GeometricAnalysis.CurveCurvatureAnalysis.")"""
        ...
