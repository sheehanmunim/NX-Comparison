...
class RouteManager(Utilities.NXRemotableObject):
    ...
    def CreateStockColorBuilder(self) -> Routing.StockColorBuilder:
        ...
    def CreateCopeCornerBuilder(self, selectedPoint: NXObject) -> Routing.CopeCornerBuilder:
    ...
    FormboardFrames: Routing.FormboardFrameCollection
...
class FormboardFrameRectangle(Routing.FormboardFrame):
    def __init__(self) -> None: ...


class FormboardFramePattern(Routing.FormboardFrame):
    def __init__(self) -> None: ...


class FormboardFrameCollection(TaggedObjectCollection):
    def EnumerateMoveNext(self, currentTag: Tag, state: bytes) -> int:
        ...
    def ToArray(self) -> typing.List[Routing.FormboardFrame]:
        ...
    def __init__(self, owner: Routing.RouteManager) -> None: ...
    def __init__(self) -> None: ...
    def CreateFormboardFrameByRectangle(self, point: Point, height: Scalar, width: Scalar) -> Routing.FormboardFrame:
        ...
    def ImportPattern(self, filename: str, type: int, frameName: str, group: DisplayableObject) -> Routing.FormboardFrame:
        ...
    def Tag(self) -> Tag: ...



class FormboardFrameCGM(Routing.FormboardFrame):
    def __init__(self) -> None: ...


class FormboardFrame(DisplayableObject):
    def __init__(self) -> None: ...
    def GetReferencePoint(self) -> Point:
        ...
    def GetObject(self, type: int) -> DisplayableObject:
        ...
    def SetReferencePoint(self, referencePoint: Point) -> None:
        ...
    def SetFrameName(self, newName: str) -> None:
        ...
    def CopyFrame(self) -> Routing.FormboardFrame:
        ...
...
class CornerTypeBuilder(TaggedObject):
    ...
    RouteCornerBendOptions: Routing.CornerTypeBuilder.BendOptions
...
class CopeCornerBuilder(Builder):
    def __init__(self) -> None: ...
    def SetStockList(self, objects: typing.List[Routing.Stock]) -> None:
        """[Obsolete("Deprecated in NX8.0.0.  Use NXOpen.Routing.AssignCornerBuilder instead..")"""
        ...
    SelectControlPoint: SelectNXObject
...
class BendCornerCollection(TaggedObjectCollection):
    ...
    def CreateCorner(self, rcp: Routing.ControlPoint, bendMethod: Routing.CornerTypeBuilder.BendMethods, bendRatio: float, bendRadius: float) -> Routing.BendCorner:
        ...
    def Create(self, rcp: Routing.ControlPoint, useBendRatio: bool, bendRatio: float, bendRadius: float) -> Routing.BendCorner:
        """[Obsolete("Deprecated in NX8.5.0.  Use Routing.BendCornerCollection.CreateCorner instead.")"""
        ...
