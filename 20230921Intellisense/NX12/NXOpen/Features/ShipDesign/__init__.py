...
class ShipPreparationBuilder(Features.FeatureBuilder):
    ...
    RemoveBlends: bool
    RemoveOpenings: bool
    ShipComponents: Assemblies.SelectComponentList
...
class ShipFlatPatternBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    def RemovePart(self, partName: str) -> None:
        """[Obsolete("Deprecated in NX8.0.0.  Use NXOpen.Features.ShipDesign.PlatePreparationBuilder instead..")"""
        ...
...
class ShipFlatPattern(Features.BodyFeature):
    def __init__(self) -> None: ...
...
class InteractiveAnnotationBuilder(Builder):
    ...
    def SetPosition(self, pos: float) -> None:
        ...
    def CreateTable(self) -> Annotations.TableSection:
        ...
