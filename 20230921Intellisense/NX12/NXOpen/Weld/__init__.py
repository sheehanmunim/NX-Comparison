...
class WeldJointBuilder(Weld.StructureWeldBuilder):
    ...
    def GetConnectedParts(self, parts: typing.List[Assemblies.Component]) -> None:
        ...
    def FindPortsInParts(self, parts: typing.List[Part], ports: typing.List[Routing.Port]) -> None:
        ...
    ...
    ButtFont: DisplayableObject.ObjectFont
    ButtWidth: DisplayableObject.ObjectWidth
    ...
    DuplicateCheck: bool
    FilletColor: int
    FilletFont: DisplayableObject.ObjectFont
    FilletWidth: DisplayableObject.ObjectWidth
...
class TransformBuilder(Features.FeatureBuilder):
    ...
    Features: Features.SelectBodyFeatureList
    MirrorPlane: Plane
    TranslateCsys: CoordinateSystem
...
class PointMarkPoint(Features.Feature):
    def __init__(self) -> None: ...
