...
class SuperSection(BlockStyler.UIBlock):
    ...
    AllowConvergentObjectWithMixedGeometries: bool
...
class BlockDialog(TransientObject):
    ...
    class BlockDialog.PerformOK_Runnable(System.Object):
    ...
    class BlockDialog.PerformCancel_Runnable(System.Object):
