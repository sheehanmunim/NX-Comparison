...
class ZlevelUndercutBuilder(CAM.MillOperationBuilder):
...
class ZigZagStepoverType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.ZigZagStepoverType.Options
...
class WeldingPointSortOrder(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.WeldingPointSortOrder.Types
...
class WeldingPointBy(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.WeldingPointBy.Types
...
class WedmOperationBuilder(CAM.OperationBuilder):
    ...
    InnerBoundary: CAM.BoundaryInnerWireEDM
...
class WallProfilingBuilder(CAM.PlanarOperationBuilder):
    def __init__(self) -> None: ...
...
class VerticalPosition(TaggedObject):
    def __init__(self) -> None: ...
    Distance: float
    DistanceExpressionBuilder: CAM.ExpressionDouble
...
class ValueIntent(enum.Enum):
    PartUnits = 0
    Function = 1


class ValueComparator(Builder):
    def __init__(self) -> None: ...


class Utils(Utilities.NXRemotableObject):
    def __init__(self, owner: CAM.CAMSession) -> None: ...
    def GetObjectsToCompare(self, type: CAM.CompareParts.ObjectTypes, userObjects: typing.List[CAM.CAMObject], objectsToCompare: typing.List[CAM.CAMObject]) -> None:
        ...
    def GetObjectsToCompareWithPart(self, type: CAM.CompareParts.ObjectTypes, userObjects: typing.List[CAM.CAMObject], userObjectParts: typing.List[Part], objectsToCompare: typing.List[CAM.CAMObject], objectsToCompareParts: typing.List[Part]) -> None:
        ...
    def SetDiffs(self, type: CAM.CompareParts.ObjectTypes, userObject: CAM.CAMObject, compareObject: CAM.CAMObject, userObjects: int) -> None:
        ...
    def GetCiId(self, builderOfInterest: TaggedObject) -> int:
        ...
    def IsContextCi(self, ci: int) -> bool:
        ...
    def GetComparePartsObject(self, userPart: str, fileToCompare: str) -> CAM.CompareParts:
        ...
    def ClonePoint(self, intputPoint: Point) -> Point:
        ...
    def CloneVector(self, intputVector: Direction) -> Direction:
        ...
    def ClonePlane(self, inputPlane: Plane) -> Plane:
        ...
    def GetHelperBuilders(self, paramBuilder: CAM.ParamBuilder, helperBuilders: typing.List[TaggedObject]) -> None:
        ...
    def SetInspectionIntent(self, isInspection: bool) -> None:
        ...
    def GetObjectsToMerge(self, ver0Objects: typing.List[CAM.CAMObject], ver0Part: Part, ver1Objects: typing.List[CAM.CAMObject], ver1Part: Part, ver2Objects: typing.List[CAM.CAMObject], ver2Part: Part) -> int:
        ...
    def GetBuildersToValidate(self, metricBuilders: typing.List[CAM.ParamBuilder], englishBuilders: typing.List[CAM.ParamBuilder]) -> None:
        ...
    def SetMismatchingDoubles(self, ciIds: int) -> None:
        ...
    def CreateMergeReports(self, version0Part: str, version1Part: str, version2Part: str) -> None:
        ...
    def MergeMasterTemplate(self, masterTemplateToMerge: str) -> None:
        ...
    def GetObjectToMerge(self, objectToMerge: CAM.CAMObject) -> str:
        ...
    def GetMergeOutputFiles(self, ver0OutputFile: str, ver1OutputFile: str, ver2OutputFile: str) -> None:
        ...
    def GetMergeReportFile(self, version2Part: str) -> str:
        ...
    def SetSimpleMergeCount(self, count: int) -> None:
        ...
    def SetComplexMergeCount(self, count: int) -> None:
        ...
    def SetSimpleMergeObjects(self, objects: typing.List[CAM.CAMObject]) -> None:
        ...
    def Tag(self) -> Tag: ...
...
class UdeParameter(TaggedObject):
    ...
    Csys: NXObject
    DoubleValue: float
    ExpressionDouble: CAM.ExpressionDouble
    ExpressionString: CAM.ExpressionString
    IntegerValue: int
    NameOfParameter: str
    OptionText: str
    OptionValue: str
...
class Ude(TaggedObject):
    ...
    def GetParameterNames(self) -> str:
        ...
    def InitializeFrom(self, udeObjToInitializeFrom: CAM.Ude) -> bool:
        ...
...
class TurnNcmTransferWithinRegions(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    TransferTypeOption: CAM.TurnNcmTransferWithinRegions.TransferTypeOptions


    class TransferTypeOptions(enum.Enum):
        Clearance = 0
        Direct = 1
    

class TurnNcmSmoothing(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    SmoothingRadius: CAM.InheritableToolDepBuilder
    SmoothingState: bool
    ToleranceTypeOption: CAM.TurnNcmSmoothing.ToleranceTypeOptions
    ToleranceValue: CAM.InheritableDoubleBuilder
...
class TurningToolBuilder(CAM.ToolBuilder):
    ...
    HolderLock: bool
    HolderShankHeightBuilder: CAM.InheritableDoubleBuilder
    ...
    InsertPositionBuilder: CAM.InheritableIntBuilder
...
class TurnCircularFeedComp(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    AdjustFeedRateOption: CAM.TurnCircularFeedComp.AdjustFeedRateOptions
...
class TurnBiTangentSmoothing(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    AdditionalCornerCleanupState: bool
    BiTangentSmoothingState: bool
    ContiguousCutsState: bool
    InsideRadius: CAM.InheritableToolDepBuilder
    MinimumInsideRadius: CAM.InheritableToolDepBuilder
    OutsideRadius: CAM.InheritableToolDepBuilder
...
class TrackBuildupAdditiveBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry


class TpMultiAxisWallFinishing(CAM.Operation):
    def __init__(self) -> None: ...


class TpMultiAxisTurnMilling(CAM.Operation):
    def __init__(self) -> None: ...


class TpMultiAxisDeburring(CAM.Operation):
    def __init__(self) -> None: ...
...
class ToolSolid(TransientObject):
    ...
    def Hide(self) -> None:
        ...
    def Transform(self, matrix: Matrix4x4) -> None:
        ...
    def Reset(self) -> None:
        ...
    def ResetPosition(self) -> None:
        ...
    def ShowAtPosition(self, point: Point3d) -> None:
        ...
...
class ToolPathTiltBuilder(CAM.ParamBuilder):
    def __init__(self) -> None: ...
    FanDistance: CAM.InheritableToolDepBuilder
    MaintainTilt: bool
...
class ToolPathSplitBuilder(Builder):
    ...
    NcmEngageRetractBuilder: CAM.NcmEngRetBuilder
...
class ToolPathRulesBuilder(CAM.ParamBuilder):
    def __init__(self) -> None: ...
    def ApplyRules(self) -> None:
        ...
    def Information(self) -> None:
        ...
    def DeleteRules(self) -> None:
        ...


class ToolPathMW5Axis(TaggedObject):
    def __init__(self) -> None: ...
    def GetMw5axisGeometries(self, items: typing.List[TaggedObject]) -> None:
        ...
    def SetMw5axisGeometries(self, items: typing.List[TaggedObject]) -> None:
        ...
    def GetMw5axisGenericValues(self) -> float:
        ...
    def SetMw5axisGenericValues(self, values: float) -> None:
        ...
    def GetMw5axisGeometry(self) -> TaggedObject:
        ...
    def SetMw5axisGeometry(self, item: TaggedObject) -> None:
        ...
    Mw5axisReversed: bool


class ToolpathGenerateResult(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    def GetObject(self) -> CAM.CAMObject:
        ...
    def GetResult(self) -> CAM.ToolpathGenerateResult.Types:
        ...
...
class ToolpathGenerateBuilder(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    def Generate(self, reuslts: typing.List[CAM.ToolpathGenerateResult]) -> None:
        ...
    GenerationType: CAM.ToolpathGenerateBuilder.Types
...
class ToolChangePositionBuilder(CAM.MoveBuilder):
    def __init__(self) -> None: ...
    AxisPosition: CAM.ToolChangePositionBuilder.AxisPositionType
    Point: Point
    Vector: Direction


    class AxisPositionType(enum.Enum):
        Default = 0
        Specify = 1
...
class ToolCenterPointBuilder(CAM.MoveBuilder):
    def __init__(self) -> None: ...
...
class ToolAxisVariable(CAM.ToolAxisBase):
    ...
    ApplySmoothing: bool
    FanDistance: CAM.InheritableToolDepBuilder
    FixedAxisOrientType: CAM.ToolAxisFixed
    ...
    class Types(enum.Enum):
        ...
        Fixed = 28
        InterpolateAroundAxis = 29
        ParametricInterpolate = 30
...
class ToolAxisTiltMainMCS(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.ToolAxisTiltMainMCS.Types
...
class ToolAxisInterpolate(TaggedObject):
    ...
    InitializeFromDriveLeadAngle: float
    InitializeFromDriveMaxAngle: float
    InitializeFromDriveStepSize: float
    InitializeFromDriveTiltAngle: float
...
class ToolAxisFilterBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def Validate(self) -> bool:
        ...
    LimitType: CAM.ToolAxisFilterBuilder.LimitTypes
    MaximalRotation: float
    MaximalTilt: float
    MinimalRotation: float
    MinimalTilt: float
...
class ToolAxisAdvanced(TaggedObject):
    def __init__(self) -> None: ...
    BladeSwarfCollisionHandling: CAM.ToolAxisAdvanced.BladeSwarfCollisionHandlingType
    BladeSwarfExtensionAlignment: CAM.ToolAxisAdvanced.BladeSwarfExtensionAlignmentType
    BladeSwarfExtensionStartAngle: float
    InterpolateVector: CAM.InterpolateVector
    LeadingAngle: float
    MinimumLeadAngle: float
    ...
    TiltAngle: float
    ToolAxisAdvancedVector: Direction
    ...
    class BladeSwarfExtensionAlignmentType(enum.Enum):
        Automatic = 0
        AlignToEdges = 1
        StartAngle = 2
    

    class BladeSwarfCollisionHandlingType(enum.Enum):
        ContactTopAndBottom = 0
        Degouge = 1
        Balance = 2
...
class Tool(CAM.NCGroup):
    ...
    def ExportPart(self, libRef: str) -> None:
        ...
    def GetToolSolid(self) -> CAM.ToolSolid:
        ...
    ...
    class Subtypes(enum.Enum):
        ...
        ThreadTriangularStandard = 39
        ThreadTriangularTrapezoidal = 40
    

class TiltingRotaryAxis(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.TiltingRotaryAxis.Types
...
class ThreadTurningBuilder(CAM.TurningOperationBuilder):
    ...
    InputMode: CAM.ThreadTurningBuilder.InputModes
...
class ThreadToolBuilder(CAM.TurningToolBuilder):
    def __init__(self) -> None: ...
    HolderHand: CAM.ThreadToolBuilder.HolderHands
    InsertShape: CAM.ThreadToolBuilder.InsertShapes
    ProfileAngle: CAM.ThreadToolBuilder.ProfileAngles
    ProfileDepthInsertBuilder: CAM.InheritableDoubleBuilder
    ProfileDistanceExBuilder: CAM.InheritableDoubleBuilder
    ProfileDistanceEyBuilder: CAM.InheritableDoubleBuilder
    ThreadHeightDifferenceBuilder: CAM.InheritableDoubleBuilder
    ThreadHeightTheoreticalBuilder: CAM.InheritableDoubleBuilder
    TipOffsetBuilder: CAM.InheritableDoubleBuilder


    class ProfileAngles(enum.Enum):
        Deg45 = 0
        Deg55 = 1
        Deg60 = 2
        Deg80 = 3
    ...
    class InsertShapes(enum.Enum):
        Standard = 0
        Trapezoidal = 1
        TriangularStandard = 2
        TriangularTrapezoidal = 3
...
class ThreadMillingBuilder(CAM.CylindricalMillingBuilder):
    ...
    MotionOutput: CAM.ThreadMillingBuilder.MotionOutputTypes
...
class TeachmodeProfileMoveBuilder(CAM.MoveBuilder):
    ...
    CircularFeedCompBuilder: CAM.TurnCircularFeedComp
...
class SwarfBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
...
class SurfaceContourBuilder(CAM.MillOperationBuilder):
    ...
    BladeDepthStepDistance: CAM.InheritableToolDepBuilder
    BladeFinish: CAM.BladeFinish
    BladeGeometryType: CAM.BladeGeometryType
    ...
    DriveMethod: CAM.SurfaceContourBuilder.DriveMethodTypes
...
class StepoverType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.StepoverType.Types
...
class StartPointType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.StartPointType.Options
...
class StampingTool(CAM.SolidToolBuilder):
    def __init__(self) -> None: ...
    def AddCuttingGeometry(self, geometry: NXObject) -> None:
        ...
    def RemoveAllCuttingGeometry(self) -> None:
        ...
...
class SpringPassesControl(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.SpringPassesControl.Types
...
class SpringPassBuilder(CAM.PowerLevelBuilder):
    def __init__(self) -> None: ...
...
class SimulationOptionsBuilder(Builder):
    ...
    ToolTraceDragging: bool
    ToolTraceLowerVelocityThreshold: float
    ToolTraceModeValue: CAM.SimulationOptionsBuilder.ToolTraceMode
    ToolTraceSize: int
    ToolTraceUpperVelocityThreshold: float
    TranslucencyValue: int


    class ToolTraceMode(enum.Enum):
        MotionType = 0
        Acceleration = 1
        Velocity = 2
...
class ShankSectionBuilder(CAM.HolderSectionBuilder):
    def __init__(self) -> None: ...
...
class ScanningLaserToolBuilder(CAM.LaserTool):
    def __init__(self) -> None: ...
    BeamWidth: CAM.InheritableDoubleBuilder
    ClearanceDistance: CAM.InheritableDoubleBuilder
    FieldOfViewFar: CAM.InheritableDoubleBuilder
    FieldOfViewNear: CAM.InheritableDoubleBuilder
    MeasurementRange: CAM.InheritableDoubleBuilder


class ScannerBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...


class SaveSliceRegionsAsMesh(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.SaveSliceRegionsAsMesh.Options
...
class SaveInfillPatternAsCurves(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.SaveInfillPatternAsCurves.Options
...
class RoughTurningBuilder(CAM.RoughFinishTurningBuilder):
    def __init__(self) -> None: ...
    BiTangentSmoothingBuilder: CAM.TurnBiTangentSmoothing
    ...
    NcmSmoothingBuilder: CAM.TurnNcmSmoothing
    NcmTransferWithinRegionsBuilder: CAM.TurnNcmTransferWithinRegions
...
class RoughFinishTurningBuilder(CAM.TurningOperationBuilder):
    ...
    MultiChannelTurningLeadMode: CAM.RoughFinishTurningBuilder.MultiChannelTurningLeadModeTypes
    MultiChannelTurningLeadRevolutions: float
    MultiChannelTurningLeadTime: float
    MultiChannelTurningMode: CAM.RoughFinishTurningBuilder.MultiChannelTurningModeTypes
    MultiChannelTurningSafeDistanceToCenterline: float
    ...
    class MultiChannelTurningLeadModeTypes(enum.Enum):
        Distance = 0
        TimeFromDistnace = 1
        Time = 2
        Revolutions = 3
...
class RotaryRoughingBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
...
class RotaryConicalBuildupAdditiveBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry
    PartAxisBuilder: CAM.PartAxisBuilder
...
class RobotCartesianMove(CAM.MoveBuilder):
    def __init__(self) -> None: ...
    def SetExternals(self, axisNames: str, axisValues: float) -> None:
        ...
    Configuration: int
...
class RegionSequencing(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.RegionSequencing.Types
...
class RadialGrooveMillingBuilder(CAM.CylindricalMillingBuilder):
    def __init__(self) -> None: ...
    CornerClearance: CAM.InheritableDoubleBuilder
...
class ProjVecCiBuilder(TaggedObject):
    ...
    DpmProjType: CAM.ProjVecCiBuilder.DpmProjTypes
    Point: Point
    Vector: Direction
...
class ProcessPatterning(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    ...
    def Reload(self) -> None:
        ...
    DirectionPatternType: CAM.ProcessPatterning.DirectionPatternTypes
    DirectionVector: Direction
    Feature: Features.PatternFeature
    OptimizationType: CAM.ProcessPatterning.OptimizationTypes
    OutputForSubroutines: bool
    PatternMcs: bool
    ...
    class DirectionPatternTypes(enum.Enum):
        Zig = 0
        Zigzag = 1
...
class ProbeProtectedParametersBuilder(TaggedObject):
    ...
    StandoffDistanceBuilder: CAM.ExpressionDouble
...
class PreprocessGeometryBuilder(Builder):
    ...
    def Create(self, obj: NXObject, tolerance: float, vector: NXObject) -> None:
        ...
    def CreateWithAngleTolerance(self, obj: DisplayableObject, tolerance: float, angularTolerance: float, vector: Direction) -> None:
        ...
...
class Preferences(Builder):
    ...
    FeatureRecognitionLenDiaRatio: float
    ...
    ProcessForceIntervalLength: float
    ProcessForceTolerance: float
    ProcessTorqueTolerance: float
    RelocateParameters: bool
    ReplayRefreshBeforeEachPath: bool
    RunProcessAssistant: bool
    SaveIpwAfterCuttingLength: float
    SaveIpwModel: bool
    ...
    VisualizeIpwDmrColor11: NXColor
    VisualizeIpwDmrColor12: NXColor
    VisualizeIpwDmrColor13: NXColor
    ...
    VisualizeIpwFeatureRefinement: bool
    ...
    VisualizeToolAxisTraceColor: NXColor
    VisualizeToolAxisTraceLength: float
    ...
    VisualizeTurningIpwTranslucency: int
    WallColor: NXColor
...
class PowerLevelBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def Add(self, indexAfter: int, layer: int, laserPower: float) -> None:
        ...
    def Modify(self, index: int, layer: int, laserPower: float) -> None:
        ...
    def Delete(self, index: int) -> None:
        ...
    def MoveUp(self, index: int) -> None:
    ...
    def MoveDown(self, index: int) -> None:
        ...
    def GetData(self, index: int, layer: int, laserPower: float) -> None:
        ...
...
class PlanarRoughingBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
...
class PlanarAdditiveSpiralBuilder(CAM.PlanarAdditiveBuilder):
    def __init__(self) -> None: ...


class PlanarAdditiveBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry
...
class PatternTypeBuilder(TaggedObject):
    ...
    class Option(enum.Enum):
        ...
        MorphAroundMedialAxis = 4
        OffsetAroundMedialAxis = 5
    

class PatternSequencing(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PatternSequencing.Types
    ...
    class Types(enum.Enum):
        ...
        AwayFromGuide = 11
        TowardFirstCurve = 12
        AlternateFromGuide1 = 13
        AlternateTowardGuide1 = 14
...
class PatternInstance(TaggedObject):
    def __init__(self) -> None: ...


class PatternDirection(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PatternDirection.Types


    class Types(enum.Enum):
        Clockwise = 0
        CounterClockwise = 1
        ClockwiseAlternate = 2
        CounterClockwiseAlternate = 3
    

class PatternAgainstShape(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PatternAgainstShape.Types
...
class PathValidator(Builder):
    def __init__(self) -> None: ...
    def SetValidationCriteria(self, criteria: typing.List[CAM.Path.FindingTypes]) -> None:
        ...
    def ValidatePathEvent(self, pathEvent: CAM.PathEvent) -> typing.List[CAM.Path.FindingTypes]:
        ...


class PathRuleType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PathRuleType.Types
...
class PathRuleOption(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PathRuleOption.Types


    class Types(enum.Enum):
        NearestNonCuttingMoves = 0
        NextNonCuttingMoves = 1
        Immediate = 2
        AfterEngage = 3
        BeforeRetract = 4
    

class PathRule(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.PathRule.Types
...
class PathOwnerData(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    def GetOperation(self) -> CAM.Operation:
        ...
    def GetTool(self) -> CAM.Tool:
        ...
...
class PathLaserMachineData(TransientObject):
    ...
    def GetMaxLaserPower(self) -> float:
        ...
    def GetMinLaserPower(self) -> float:
        ...
    def GetTool(self) -> CAM.Tool:
        ...
...
class PathLaserGeometryData(TransientObject):
    ...
    def GetAmFeatureBody(self) -> TaggedObject:
        ...
    def GetAmFeatureBodies(self) -> typing.List[Body]:
        ...
    def GetMergedOperations(self) -> typing.List[CAM.Operation]:
        ...
...
class PathEventDataSixthAxis(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    Vector: Vector3d
...
class PathEventDataCornerMarker(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    Type: CAM.PathEventDataCornerMarker.Types
    VertexAngle: float
...
class PathEvent(TransientObject):
    ...
    def GetPrevious(self) -> CAM.PathEvent:
        ...
    def GetRegionMesh(self) -> Facet.FacetedBody:
        ...
    def GetCornerMarkerData(self, cornerMarkerData: CAM.PathEventDataCornerMarker) -> bool:
        ...
    def GetSixthAxis(self, sixthAxisData: CAM.PathEventDataSixthAxis) -> bool:
        ...
...
class PathDisplay(Utilities.NXRemotableObject):
    ...
    def StepDisplay(self, isFwd: bool) -> None:
        ...
    def Jump(self, isFwd: bool) -> None:
        ...
    def SetAnimationSpeed(self, speed: int) -> None:
        ...
    def SetIpwResolution(self, resolution: CAM.PathDisplay.IpwResolutionType) -> None:
        ...
    def SetToolDisplayType(self, type: CAM.PathDisplay.ToolDisplayType) -> None:
        ...
    def SetToolAxisTraceScale(self, scaleFactor: int) -> None:
        ...
    def Tag(self) -> Tag: ...

    ColorBy: CAM.PathDisplay.ColorByType
    DisplayToolPath: bool
    ...
    class ToolDisplayType(enum.Enum):
        Point = 0
        Axis = 1
        Solid = 2
        SolidWithHolder = 3
    ...
    class IpwResolutionType(enum.Enum):
        Coarse = 0
        Medium = 1
        Fine = 2
...
class Path(TaggedObject):
    ...
    def AddMarker(self, data: CAM.PathMarker, location: CAM.CamPathToolpathEventLocation, referenceEvent: CAM.PathEvent) -> CAM.PathEvent:
        ...
    def GetNumberOfFindings(self, type: CAM.Path.FindingTypes) -> int:
        ...
    def ModifyLinearMotion(self, data: CAM.PathLinearMotion, eventOfInterest: CAM.PathEvent) -> CAM.PathEvent:
        ...
    def ModifyCircularMotion(self, data: CAM.PathCircularMotion, eventOfInterest: CAM.PathEvent) -> CAM.PathEvent:
        ...
    def ModifyHelixMotion(self, data: CAM.PathHelixMotion, eventOfInterest: CAM.PathEvent) -> CAM.PathEvent:
        ...
    def IsFirstEvent(self, eventOfInterest: CAM.PathEvent) -> bool:
        ...
    def IsLastEvent(self, eventOfInterest: CAM.PathEvent) -> bool:
        ...
    def GetWidthHeight(self, eventOfInterest: CAM.PathEvent, width: float, height: float) -> None:
        ...
    def SetWidthHeight(self, eventOfInterest: CAM.PathEvent, width: float, height: float) -> None:
        ...
    def CopyEvent(self, eventToCopy: CAM.PathEvent, location: CAM.CamPathToolpathEventLocation, referenceEvent: CAM.PathEvent) -> CAM.PathEvent:
        ...
    def GetReferenceData(self) -> CAM.PathOwnerData:
        ...
    def HasSubPath(self) -> bool:
        ...
    def GetSubPathData(self, forEvent: CAM.PathEvent) -> CAM.PathOwnerData:
        ...
    ContactType: CAM.CamPathContactType
    NumberOfToolpathEvents: int
    RobotRulesStatus: CAM.Path.RobotRulesStatusStates
    ToolAxisType: CAM.CamPathToolAxisType


    class RobotRulesStatusStates(enum.Enum):
        Unchanged = 0
        Changed = 1
        Regenerate = 2
        Regenerated = 3
...
class OutputForMcsBuilder(CAM.MoveBuilder):
    def __init__(self) -> None: ...
    Mcs: CAM.OutputForMcsBuilder.Types
...
class OutputAxis(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.OutputAxis.Types


    class Types(enum.Enum):
        Automatic = 0
        NormalToLevel = 1
        AwayFromAxisOfRotation = 2
        InterpolateTilt = 3
        AlignTiltFromPoint = 4
        TowardPoint = 5
        FixedVector = 6
        NormalToDrive = 7
        TowardLine = 8
        TowardFiniteLine = 9
        FourAxisNormalToDrive = 10
        AwayFromFixedPoint = 11
        AwayFromLine = 12
        AwayFromFiniteLine = 13
        TangentToCurve = 14
        AlignTiltFromCurve = 15
        TowardCurve = 16
        AwayFromCurve = 17
        RelativeToDrive = 18
        ParametricInterp = 19
        InterpolateBetween = 20
        SameAsInfill = 21
        SameAsFinishPass = 22
...
class OrientGeomBuilder(CAM.NCGroupBuilder):
    ...
    def SetToolAxisMode(self, toolAxisMode: CAM.OrientGeomBuilder.ToolAxisModes) -> None:
        ...
    def SetBlockMcsOrigin(self, zeroFace: CAM.OrientGeomBuilder.McsZeroFace, zeroPosition: CAM.OrientGeomBuilder.McsZeroPosition) -> None:
        ...
    def SetCylinderMcsOrigin(self, zeroFace: CAM.OrientGeomBuilder.McsZeroFace) -> None:
        ...
    FixtureOffsetBuilder: CAM.InheritableIntBuilder
    LayoutCiBuilder: CAM.LayoutCiBuilder
    LinkRcsToMcs: bool
    Mcs: CartesianCoordinateSystem
    McsLocationMode: CAM.OrientGeomBuilder.McsLocationModes
    McsWorkpiece: NXObject
    Rcs: CartesianCoordinateSystem
    ToolAxisFilterBuilder: CAM.ToolAxisFilterBuilder
    ...
    class McsZeroPosition(enum.Enum):
        Center = 0
        North = 1
        NorthEast = 2
        East = 3
    ...
    class McsZeroFace(enum.Enum):
        Bottom = 0
        Middle = 1
        Top = 2
    

    class McsLocationModes(enum.Enum):
        Specify = 0
        OnBlank = 1
        OnPartBox = 2
...
class OperationCollection(TaggedObjectCollection):
    ...
    def CreateMillUserDefinedBuilder(self, param: CAM.CAMObject) -> CAM.MillUserDefinedBuilder:
        ...
    def CreateMwBldeburringOperationBuilder(self, param: CAM.CAMObject) -> CAM.MwBLDeburringOperationBuilder:
        ...
    ...
    def CreateGenericFeatureOperationBuilder(self, param: CAM.CAMObject) -> CAM.GenericFeatureOperationBuilder:
        ...
    def CreateEdgeChamferBuilder(self, param: CAM.CAMObject) -> CAM.EdgeChamferBuilder:
        ...
    def CreateMultiAxisRoughingBuilder(self, param: CAM.CAMObject) -> CAM.MultiAxisRoughingBuilder:
        ...
    def CreatePlanarRoughingBuilder(self, param: CAM.CAMObject) -> CAM.PlanarRoughingBuilder:
        ...
    def CreateFacingBuilder(self, param: CAM.CAMObject) -> CAM.FacingBuilder:
        ...
    def CreateFacingZigZagBuilder(self, param: CAM.CAMObject) -> CAM.FacingZigZagBuilder:
        ...
    def CreateZlevelUndercutBuilder(self, param: CAM.CAMObject) -> CAM.ZlevelUndercutBuilder:
        ...
    def CreateSwarfBuilder(self, param: CAM.CAMObject) -> CAM.SwarfBuilder:
        ...
    def CreateRotaryRoughingBuilder(self, param: CAM.CAMObject) -> CAM.RotaryRoughingBuilder:
        ...
    def CreatePlanarAdditiveBuilder(self, param: CAM.CAMObject) -> CAM.PlanarAdditiveBuilder:
        ...
    def CreatePlanarAdditiveSpiralBuilder(self, param: CAM.CAMObject) -> CAM.PlanarAdditiveBuilder:
        ...
    def CreateTrackBuildupAdditiveBuilder(self, param: CAM.CAMObject) -> CAM.TrackBuildupAdditiveBuilder:
        ...
    def CreateRotaryConicalBuildupAdditiveBuilder(self, param: CAM.CAMObject) -> CAM.RotaryConicalBuildupAdditiveBuilder:
        ...
    def CreateScannerBuilder(self, param: CAM.CAMObject) -> CAM.ScannerBuilder:
        ...
    def CreateBuilder(self, param: CAM.CAMObject) -> CAM.OperationBuilder:
        ...
    def CreateMultiAxisDeburringBuilder(self, param: CAM.CAMObject) -> CAM.MultiAxisDeburringBuilder:
        ...
    def CreateWallProfilingBuilder(self, param: CAM.CAMObject) -> CAM.WallProfilingBuilder:
        ...
    def CreateMultiAxisWallFinishingBuilder(self, param: CAM.CAMObject) -> CAM.MultiAxisWallFinishingBuilder:
        ...
    def CreateMultiAxisTurnMillingBuilder(self, param: CAM.CAMObject) -> CAM.MultiAxisTurnMillingBuilder:
        ...
    def CreateOnMachineProbingBuilder(self, param: CAM.CAMObject) -> CAM.OnMachineProbingBuilder:
        ...
    def Tag(self) -> Tag: ...
...
class Operation(CAM.CAMObject):
    ...
    def UnlinkInstance(self) -> None:
        ...
    def GenerateIpw(self, checkCollisions: bool, useHolder: bool) -> None:
        ...
    ...
    def ResetGougeChecking(self) -> None:
        ...
    def PerformSpikeCheck(self) -> None:
        ...
    ...
    def ComparePath(self, positionTolerance: float, angleTolerance: float, exactCompare: bool, realCompare: bool, tubeCompare: bool) -> bool:
        ...
    def ComparePath(self, positionTolerance: float, angleTolerance: float, exactCompare: bool, realCompare: bool, tubeCompare: bool, realCompareDetailed: bool, stopAfterNDiffs: int, realCPosDiff: int, realCOrientDiff: int) -> bool:
        ...
    ...
    def IsMaintainCutAngle(self) -> bool:
        ...
    def GetTransformationMatrix(self, rotationMatrix: Matrix3x3, translation: Vector3d, scale: float) -> bool:
        ...
    def GetTransitionPathOperation(self, transitionPathType: CAM.Operation.TransitionPathTypes) -> CAM.GenericMotionControl:
        ...
    def GenerateAndSaveTransitionPath(self, transitionPathType: CAM.Operation.TransitionPathTypes, transitionPathOpr: CAM.GenericMotionControl) -> None:
        ...
    ...
    class TransitionPathTypes(enum.Enum):
        None = 0
        Before = 1
        Between = 2
        After = 3
...
class OnMachineProbingBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...
    def ShowGeometry(self) -> None:
        ...
    def CycleLock(self) -> None:
        ...
    def ProbingParameters(self) -> None:
        ...
    def GetInspectDirection(self) -> float:
        ...
    def SetInspectDirection(self, direction: float) -> None:
        ...
    def FeatureRemove(self) -> None:
        ...
    def FeatureMoveUp(self) -> None:
        ...
    def FeatureMoveDown(self) -> None:
        ...
    def InspectionDepthLock(self) -> None:
        ...
    def InspectionOffsetLock(self) -> None:
        ...
    def InspectionCycleLock(self) -> None:
        ...
    def ProcessSelectedGeometry(self) -> None:
        ...
    def ProcessSelectedCycle(self) -> None:
        ...
    def CreateToolpathMoves(self) -> None:
        ...
    ControlPoint: CAM.OnMachineProbingBuilder.ControlPointType
    Cycle: str
    InProcessWorkpiece: CAM.OnMachineProbingBuilder.InProcessWorkpieceType
    InspectionArea: str
    InspectionCycle: str
    InspectionDepth: float
    InspectionOffset: float
    IntersectionStrategy: CAM.OnMachineProbingBuilder.IntersectionStrategyType
    MotionOutput: CAM.OnMachineProbingBuilder.MotionOutputType
    SelectFeatureGeometry: SelectNXObjectList
    SelectionMethod: CAM.OnMachineProbingBuilder.SelectionMethodType


    class SelectionMethodType(enum.Enum):
        Feature = 0
        Faces = 1
        Curves = 2
        Points = 3
    ...
    class MotionOutputType(enum.Enum):
        MachineCycle = 0
        SingleMoves = 1
    ...
    class InProcessWorkpieceType(enum.Enum):
        None = 0
        Use3D = 1
        Local = 2
    

    class ControlPointType(enum.Enum):
        InProcessFeature = 0
        MachiningFeature = 1
...
class NotesMoveBuilder(CAM.MoveBuilder):
    def __init__(self) -> None: ...
...
class NcmTransferBuilder(TaggedObject):
    ...
    DepartureToolAxis: Direction
    DepartureToolAxisOption: CAM.NcmTransferBuilder.AppDepToolAxisOptions
    DepartureVector: Direction
    TraUdeSet: CAM.UdeSet
    TransferUsing: CAM.NcmSubopBuilder.TransferUsing
    TransferUsingHeight: CAM.InheritableToolDepBuilder
    TransferUsingMaxFollowDistance: CAM.InheritableToolDepBuilder
...
class NcmTransfer(TaggedObject):
    ...
    KinematicsBasedTransition: bool
    MaxToolAxisChange: float
...
class NcmScBuilder(CAM.NcmSubopBuilder):
    ...
    MaxStepoverBuilder: CAM.InheritableToolDepBuilder
    MaxToolAxisChange: float
...
class NcmOptimizeGroup(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    CollisionCheck: bool
...
class NcmClearanceBuilder(TaggedObject):
    ...
    Radius: float
    SafeDistance: float
    SafeDistanceBuilder: CAM.ExpressionDouble
...
class NCGroupCollection(TaggedObjectCollection):
    ...
    def CreateDrillChamferBoringBarTool(self, param: CAM.CAMObject) -> CAM.DrillChamferBoringBarTool:
        ...
    def CreateFusedDepositionTool(self, param: CAM.CAMObject) -> CAM.FusedDepositionToolBuilder:
        ...
    def CreateCarbonFiberTool(self, param: CAM.CAMObject) -> CAM.CarbonFiberToolBuilder:
        ...
    def CreateLaserHardeningTool(self, param: CAM.CAMObject) -> CAM.LaserHardeningTool:
        ...
    def CreateScanningLaserTool(self, param: CAM.CAMObject) -> CAM.ScanningLaserToolBuilder:
        ...
    def CreateStampingTool(self, param: CAM.CAMObject) -> CAM.StampingTool:
        ...
    def CreateNcgroupBuilder(self, param: CAM.CAMObject) -> CAM.NCGroupBuilder:
        ...
    def CreateMergePathAdditiveBuilder(self, param: CAM.CAMObject) -> CAM.NCGroupBuilder:
        ...
    def CreateMergePathSubtractiveBuilder(self, param: CAM.CAMObject) -> CAM.NCGroupBuilder:
        ...
    def Tag(self) -> Tag: ...
...
class MwBLDeburringOperationBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...


class MwBLDeburringOperation(CAM.Operation):
    def __init__(self) -> None: ...
...
class MultipleBaseFaceGeometry(TaggedObject):
    def __init__(self) -> None: ...
    FaceNormalReversed: bool
    Faces: SelectFaceList
...
class MultiAxisWallFinishingBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry
    CustomNcmClearanceBuilder: CAM.CustomNcmClearanceBuilder
    CutPatternTypeBuilder: CAM.ElementIntBuilder
    WallGeometry: CAM.Geometry


class MultiAxisTurnMillingBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry
    CustomNcmClearanceBuilder: CAM.CustomNcmClearanceBuilder


class MultiAxisRoughingBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...


class MultiAxisDeburringBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...
    CheckGeometry: CAM.Geometry
    CustomNcmClearanceBuilder: CAM.CustomNcmClearanceBuilder
    ToolContactPointFlagBuilder: CAM.ElementIntBuilder
...
class MoveCollection(TaggedObjectCollection):
    ...
    def CreateContainerMoveBuilder(self, param: CAM.Move, moveType: int) -> CAM.ContainerMoveBuilder:
        ...
    def CreateContactMoveBuilder(self, param: CAM.Move) -> CAM.ContactMoveBuilder:
        ...
    ...
    def CreateLinearGoDeltaMoveBuilder(self, param: CAM.Move) -> CAM.LinearLocalCsysMoveBuilder:
        """[Obsolete("Deprecated in NX12.0.2.  Please use CAM.MoveCollection.CreateLinearLocalCsysMoveBuilder instead.")"""
        ...
    def CreateLinearGotoMoveBuilder(self, param: CAM.Move) -> CAM.LinearLocalCsysMoveBuilder:
        """[Obsolete("Deprecated in NX12.0.2.  Please use CAM.MoveCollection.CreateLinearLocalCsysMoveBuilder instead.")"""
        ...
    def CreateLinearLocalCsysMoveBuilder(self, param: CAM.Move) -> CAM.LinearLocalCsysMoveBuilder:
        ...
    def CreateToolCenterPointOnBuilder(self, param: CAM.Move) -> CAM.ToolCenterPointBuilder:
        ...
    def CreateToolCenterPointOffBuilder(self, param: CAM.Move) -> CAM.ToolCenterPointBuilder:
        ...
    def CreateOutputForMcsBuilder(self, param: CAM.Move) -> CAM.OutputForMcsBuilder:
        ...
    def CreateNotesMoveBuilder(self, param: CAM.Move) -> CAM.NotesMoveBuilder:
        ...
    def Tag(self) -> Tag: ...
...
class MoveBuilder(Builder):
    ...
    def GetUserParameter(self, index: int) -> CAM.UdeParameter:
        ...
    CustomParameterSetListBuilder: CAM.CustomParameterDataSetList
    FeedRate: float
...
class MillToolBuilder(CAM.MillingToolBuilder):
    ...
    ReliefDiameterBuilder: CAM.InheritableDoubleBuilder
    ReliefLengthBuilder: CAM.InheritableDoubleBuilder
...
class MillingToolBuilder(CAM.ToolBuilder):
    ...
    ShankSectionBuilder: CAM.ShankSectionBuilder
    ...
    ToolHelixAngleBuilder: CAM.InheritableDoubleBuilder
...
class MillCutParameters(CAM.CutParameters):
    ...
    TrimBehavior: CAM.CutParametersTrimBehaviorTypes
...
class MergePathSubtractiveBuilder(CAM.NCGroupBuilder):
    def __init__(self) -> None: ...
    NonCuttingBuilder: CAM.NcmScBuilder


class MergePathSubtractive(CAM.NCGroup):
    def __init__(self) -> None: ...


class MergePathSortOrder(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.MergePathSortOrder.Types
    ...
    class Types(enum.Enum):
        ...
        AwayFromLine = 5
        ByLevelCount = 6
        DistanceFromFoundation = 7
    

class MergePathLayerThicknessType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.MergePathLayerThicknessType.Options
...
class MergePathAdditiveBuilder(CAM.NCGroupBuilder):
    def __init__(self) -> None: ...
    NonCuttingBuilder: CAM.NcmScBuilder


class MergePathAdditive(CAM.NCGroup):
    def __init__(self) -> None: ...
...
class MaxCutStep(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.MaxCutStep.Types


    class Types(enum.Enum):
        FinishPassesOnly = 0
        InfillsAndFinishPasses = 1
...
class ManualVectorListBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def Add(self, indexAfterPosition: int, point: Point, vector: Direction) -> None:
        ...
...
class MachineLimitMoveBuilder(CAM.MoveBuilder):
    ...
    SafeDistance: float
    SafePosition: CAM.MachineLimitMoveBuilder.SafePositionType


    class SafePositionType(enum.Enum):
        MachineLimit = 0
        UserDefined = 1
...
class LinearLocalCsysMoveBuilder(CAM.MoveBuilder):
    ...
    Intent: CAM.LinearLocalCsysMoveBuilder.MoveIntent


    class MoveIntent(enum.Enum):
        Absolute = 0
        Incremental = 1
    

class LevelToLevelCiBuilder(TaggedObject):
    def __init__(self) -> None: ...
    LevelToLevelType: CAM.LevelToLevelCiBuilder.JaCamLevelToLevelTypes
    RampAngle: float
    RampDistance: CAM.InheritableToolDepBuilder
    RevolveAngle: float


    class JaCamLevelToLevelTypes(enum.Enum):
        RampAngle = 0
        RevolveAngle = 1
        RampDistance = 2
...
class LevelPlaneBuilder(TaggedObject):
    def __init__(self) -> None: ...
    PlaneDist: float


class LengthIntent(enum.Enum):
    PartUnits = 0
    Percent = 1
...
class LayerControl(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.LayerControl.Types


    class Types(enum.Enum):
        EntireFeature = 0
        NumberOfLayers = 1
        StartAndEndLayerNumber = 2
...
class LaserHardeningTool(CAM.SolidToolBuilder):
    def __init__(self) -> None: ...
    def AddLaserBeamGeometry(self, geometry: NXObject) -> None:
        ...
    def RemoveAllLaserBeamGeometry(self) -> None:
        ...
...
class InterpolateMaterialControl(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.InterpolateMaterialControl.Types
...
class InterpolateControl(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.InterpolateControl.Types
...
class InterpMaterialBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def Add(self, indexAfter: int, distanceFromFoundation: float, percentMaterial1: float) -> None:
        ...
    def Modify(self, index: int, distanceFromFoundation: float, percentMaterial1: float) -> None:
        ...
    def Delete(self, index: int) -> None:
        ...
    def MoveUp(self, index: int) -> None:
    ...
    def MoveDown(self, index: int) -> None:
        ...
    def GetData(self, index: int, distanceFromFoundation: float, percentMaterial1: float) -> None:
        ...
    Material1: str
    Material2: str


class InspectionVerifyProgramBuilder(Builder):
    def __init__(self) -> None: ...
    def VerifyProgram(self) -> None:
        ...
    CheckDmisSyntax: bool
    CheckProgramErrors: bool
    CheckToleranceErrors: bool
    ColorIonRows: bool
    ListOutput: bool
    LogFile: str
    ProgramColor: NXColor
    SyntaxColor: NXColor
...
class InspectionUVGridBuilder(CAM.InspectionMoveBuilder):
    ...
    DistanceFromEdge: CAM.InheritableDoubleBuilder
...
class InspectionTorusFeatureBuilder(CAM.OperationBuilder):
    ...
    DataFilterBuilder: CAM.InspectionFeatureDataFilterBuilder
...
class InspectionToleranceOperationBuilder(CAM.OperationBuilder):
    ...
    CoordinateTolerancePCSLabel: str
    ...
    EnumParamTolWidthDirectionMode: CAM.InspectionToleranceOperationBuilder.ParamTolWidthDirectionMode
    ...
    UnitBasisExtentDiameter: float
    UnitBasisExtentDiameterSource: CAM.InspectionToleranceOperationBuilder.ToleranceSource
    UnitBasisExtentLength: float
    UnitBasisExtentLengthSource: CAM.InspectionToleranceOperationBuilder.ToleranceSource
    UnitBasisExtentType: CAM.InspectionToleranceOperationBuilder.UnitBasisExtent
    UnitBasisExtentTypeSource: CAM.InspectionToleranceOperationBuilder.ToleranceSource
    UnitBasisExtentWidth: float
    UnitBasisExtentWidthSource: CAM.InspectionToleranceOperationBuilder.ToleranceSource
    UnitBasisTolValue: float
    UnitBasisTolValueSource: CAM.InspectionToleranceOperationBuilder.ToleranceSource
    UpperDMS: str
    ...
    class UnitBasisExtent(enum.Enum):
        TotalOnly = 0
        LengthOnly = 1
        TotalAndLength = 2
        RectangularArea = 3
        TotalAndRectangularArea = 4
        CircularArea = 5
        TotalAndCircularArea = 6
        SphericalArea = 7
        TotalAndSphericalArea = 8
        SquareArea = 9
        TotalAndSquareArea = 10
    ...
    class ParamTolWidthDirectionMode(enum.Enum):
        None = 0
        Length = 1
        Width = 2
        Vector = 3
...
class InspectionScanLineBuilder(CAM.InspectionMoveBuilder):
    ...
    DistanceFromEdgeBuilder: CAM.InheritableDoubleBuilder
    EndDistance: float
    EndDistanceBuilder: CAM.InheritableDoubleBuilder
    EndPercentage: CAM.InheritableDoubleBuilder
    EndUDistance: float
    EndUDistanceBuilder: CAM.InheritableDoubleBuilder
    EndUPercent: float
    EndUPercentBuilder: CAM.InheritableDoubleBuilder
    EndVDistance: float
    EndVDistanceBuilder: CAM.InheritableDoubleBuilder
    EndVPercent: float
    EndVPercentBuilder: CAM.InheritableDoubleBuilder
    Line: NXObject
    MinimumLengthFactor: float
    MinimumLengthFactorBuilder: CAM.InheritableDoubleBuilder
    NumberOfXSects: int
    NumberOfXSectsBuilder: CAM.InheritableIntBuilder
    RegionSequenceDirection: CAM.InspectionMethodBuilder.PointSequenceDirectionTypes
    RegionSequenceMode: CAM.InspectionMethodBuilder.PointSequenceModeTypes
    RegionSequenceStart: CAM.InspectionMethodBuilder.PointSequenceStartTypes
    RetractDist: CAM.InheritableDoubleBuilder
    Reversedirection: bool
    ...
    StartUDistance: float
    StartUDistanceBuilder: CAM.InheritableDoubleBuilder
    StartUMode: CAM.InspectionMethodBuilder.UVModeTypes
    StartUPercent: float
    StartUPercentBuilder: CAM.InheritableDoubleBuilder
    StartVDistance: float
    StartVDistanceBuilder: CAM.InheritableDoubleBuilder
    StartVMode: CAM.InspectionMethodBuilder.UVModeTypes
    StartVPercent: float
    StartVPercentBuilder: CAM.InheritableDoubleBuilder
...
class InspectionScanCurveBuilder(CAM.InspectionMoveBuilder):
    ...
    EndDistanceBuilder: CAM.InheritableDoubleBuilder
    EndPercentage: CAM.InheritableDoubleBuilder
    FilletRadiusBuilder: CAM.InheritableDoubleBuilder
    MaxSpacing: CAM.InheritableDoubleBuilder
    MinSpacing: CAM.InheritableDoubleBuilder
    NbPointsBuilder: CAM.InheritableIntBuilder
    Nbpoints: int
    PathPointBuilder: CAM.InspectionPathPointBuilder
    RetractDist: CAM.InheritableDoubleBuilder
    Reversedirection: bool
    ScanForce: CAM.InheritableDoubleBuilder
    ScanSpeed: CAM.InheritableDoubleBuilder
    StartDistance: float
    StartDistanceBuilder: CAM.InheritableDoubleBuilder
    StartEndMode: CAM.InspectionMethodBuilder.UVModeTypes
    StartPercentage: CAM.InheritableDoubleBuilder
    StepSize: CAM.InheritableDoubleBuilder
    StopRadius: CAM.InheritableDoubleBuilder
...
class InspectionScanArcBuilder(CAM.InspectionMoveBuilder):
    ...
    EndUPercentBuilder: CAM.InheritableDoubleBuilder
    EndVDeg: float
    EndVDegBuilder: CAM.InheritableDoubleBuilder
    EndVDistance: float
    EndVDistanceBuilder: CAM.InheritableDoubleBuilder
    EndVPercent: float
    EndVPercentBuilder: CAM.InheritableDoubleBuilder
    EndVSweep: float
    EndVSweepBuilder: CAM.InheritableDoubleBuilder
    MinimumLengthFactor: float
    MinimumLengthFactorBuilder: CAM.InheritableDoubleBuilder
    NumberOfXSects: int
    NumberOfXSectsBuilder: CAM.InheritableIntBuilder
    RegionSequenceMode: CAM.InspectionMethodBuilder.ArcScanRegionSequenceModeTypes
    RegionSequenceStart: CAM.InspectionMethodBuilder.ArcScanSequenceStartTypes
    RetractDist: CAM.InheritableDoubleBuilder
    Reversedirection: bool
    RotaryTableName: str
    ScanModeType: CAM.InspectionMethodBuilder.ScanModeTypes
    ...
    StartUPercentBuilder: CAM.InheritableDoubleBuilder
    StartVDeg: float
    StartVDegBuilder: CAM.InheritableDoubleBuilder
    StartVDistance: float
    StartVDistanceBuilder: CAM.InheritableDoubleBuilder
    StartVMode: CAM.InspectionMethodBuilder.UVModeTypes
    StartVPercent: float
    StartVPercentBuilder: CAM.InheritableDoubleBuilder
    StartVSweep: float
    StartVSweepBuilder: CAM.InheritableDoubleBuilder
    StepSize: CAM.InheritableDoubleBuilder
...
class InspectionResequencePathsBuilder(Builder):
    def __init__(self) -> None: ...
    def GetSelectedOps(self) -> typing.List[CAM.CAMObject]:
        ...
    def SetSelectedOps(self, paths: typing.List[CAM.CAMObject]) -> None:
        ...
    def ResequencePaths(self) -> None:
        ...
    CheckHeadAngle: bool
    CheckMoveDistance: bool
    CheckToolChange: bool
...
class InspectionPolarGridBuilder(CAM.InspectionMoveBuilder):
    ...
    TransitionMotion: CAM.InspectionMethodBuilder.TransitionMotionTypes
    UseFeatureCollisionAvoidance: bool
    UsePartCollisionAvoidance: bool
...
class InspectionPathPointBuilder(TaggedObject):
    ...
    def Delete(self, index: int) -> None:
        ...
    def GetScanData(self, index: int, scanSpeed: float, stepSize: float) -> None:
        ...
    def SetScanData(self, index: int, scanSpeed: float, stepSize: float) -> None:
        ...
...
class InspectionPathBuilder(CAM.OperationBuilder):
    ...
    def UpdatePath(self) -> None:
        ...
    ClearanceMode: CAM.InspectionPathBuilder.ClearanceModeType
    ...
    class ClearanceModeType(enum.Enum):
        SafePlane = 0
        BoundingBox = 1
...
class InspectionOperationCollection(TaggedObjectCollection):
    ...
    def CreateImportDmisBuilder(self, programGroup: CAM.InspectionGroup) -> CAM.InspectionImportDmisBuilder:
        ...
    def CreateVerifyProgramBuilder(self) -> CAM.InspectionVerifyProgramBuilder:
        ...
    def CreateResequencePathsBuilder(self) -> CAM.InspectionResequencePathsBuilder:
        ...
    def CreateMassEditBuilder(self) -> CAM.InspectionMassEditBuilder:
        ...
    def CreateCmmProbingBuilder(self, param: CAM.CAMObject) -> CAM.CmmProbingBuilder:
        ...
    def Tag(self) -> Tag: ...
...
class InspectionMoveCollection(TaggedObjectCollection):
    ...
    def CreateInspectionPolarGridBuilder(self, param: CAM.InspectionMoveSubop) -> CAM.InspectionPolarGridBuilder:
        ...
    def CreateInspectionCircularMoveToPointBuilder(self, param: CAM.InspectionMoveSubop) -> CAM.InspectionCircularMoveToPointBuilder:
        ...
    def Tag(self) -> Tag: ...
...
class InspectionMethodBuilder(CAM.MethodBuilder):
    ...
    ApproachDistance: float
    ArcScanDistanceFromEdge: float
    ArcScanEndUDistance: float
    ArcScanEndUPercent: float
    ArcScanEndVDeg: float
    ArcScanEndVDistance: float
    ArcScanEndVPercent: float
    ArcScanEndVSweep: float
    ArcScanMinimumLengthFactor: float
    ArcScanRegionSequenceMode: CAM.InspectionMethodBuilder.ArcScanRegionSequenceModeTypes
    ArcScanRegionSequenceStart: CAM.InspectionMethodBuilder.ArcScanSequenceStartTypes
    ArcScanStartUDistance: float
    ArcScanStartUMode: CAM.InspectionMethodBuilder.UVModeTypes
    ArcScanStartUPercent: float
    ArcScanStartVDeg: float
    ArcScanStartVDistance: float
    ArcScanStartVMode: CAM.InspectionMethodBuilder.UVModeTypes
    ArcScanStartVPercent: float
    ArcScanStartVSweep: float
    ArcScanUCount: int
    ArcScanVCount: int
    ...
    DataFilter: CAM.InspectionMethodBuilder.DataFilterTypes
    DataFilterFunction: CAM.InspectionMethodBuilder.DataFilterFunctionTypes
    DataFilterMaxPassValue: float
    DataFilterMinPassValue: float
    DataFilterPass: CAM.InspectionMethodBuilder.DataFilterPassTypes
    ...
    LineScan: bool
    LineScanDistanceFromEdge: float
    LineScanEndUDistance: float
    LineScanEndUPercent: float
    LineScanEndVDistance: float
    LineScanEndVPercent: float
    LineScanMinimumLengthFactor: float
    LineScanRegionSequenceDirection: CAM.InspectionMethodBuilder.PointSequenceDirectionTypes
    LineScanRegionSequenceMode: CAM.InspectionMethodBuilder.PointSequenceModeTypes
    LineScanRegionSequenceStart: CAM.InspectionMethodBuilder.PointSequenceStartTypes
    LineScanStartUDistance: float
    LineScanStartUMode: CAM.InspectionMethodBuilder.UVModeTypes
    LineScanStartUPercent: float
    LineScanStartVDistance: float
    LineScanStartVMode: CAM.InspectionMethodBuilder.UVModeTypes
    LineScanStartVPercent: float
    LineScanUCount: int
    LineScanVCount: int
    ManualPoint: bool
    MaxSpacing: float
    MaximumRadius: float
    MaximumRadiusMode: CAM.InspectionMethodBuilder.PolarRadiusModeTypes
    MeasurePointDistanceFromEdge: float
    ...
    SensorStrategy: CAM.InspectionMoveBuilder.SensorStrategyTypes
    Speed: int
    SpikeElimination: CAM.InspectionMethodBuilder.SpikeEliminationTypes
    SpikeEliminationStdDev: float
    StartDistance: float
    StartEndMode: CAM.InspectionMethodBuilder.UVModeTypes
    ...
    class TransitionMotionTypes(enum.Enum):
        Linear = 0
        Circular = 1
    ...
    class SpikeEliminationTypes(enum.Enum):
        Off = 0
        StandardDeviation = 1
    ...
    class DataFilterTypes(enum.Enum):
        Off = 0
        Circular = 1
    

    class DataFilterPassTypes(enum.Enum):
        Low = 0
        High = 1
        Band = 2
    

    class DataFilterFunctionTypes(enum.Enum):
        Gauss = 0
        TwoRC = 1
        Spline = 2
        Rectangle = 3
    ...
    class ArcScanSequenceStartTypes(enum.Enum):
        Minimum = 0
        Maximum = 1
    

    class ArcScanRegionSequenceModeTypes(enum.Enum):
        Zig = 0
        ZigZag = 1
...
class InspectionMeasDataBuilder(Builder):
    ...
    InspectionDate: str
    Layer: int
    MaximumNormalAngle: float
    MaximumPointToFaceDistance: float
    MeaFile: str
    MeasuredPartName: str
    MinimumPointToPointDistance: float
    NeedleScale: float
    OffsetDist: float
    PcsName: str
    PointDistanceTolerance: float
    ProjectLimit: float
    RequireThatPointsProjectToFace: bool
    RunNumber: str
    SelectedPoints: SelectNXObjectList
    SpecifyMaximumNormalAngle: bool
    SpecifyMaximumPointToFaceDistance: bool
    SpecifyMinimumPointToPointDistance: bool
    SpecifyPointDistance: bool
    StlFileUnits: CAM.InspectionMeasDataBuilder.StlFileUnitsType
    ...
    class StlFileUnitsType(enum.Enum):
        Millimeters = 0
        Inches = 1
...
class InspectionMassEditBuilder(Builder):
    def __init__(self) -> None: ...
    def SetOperations(self, operations: typing.List[CAM.CAMObject]) -> None:
        ...
    def MassEdit(self) -> None:
        ...
    AngleA: float
    AngleB: float
    ApproachDistance: float
    ChangeAngleA: bool
    ChangeAngleB: bool
    ChangeApproachDistance: bool
    ChangeEntryPoint: bool
    ChangeExitPoint: bool
    ChangeHeightAboveFeature: bool
    ChangeLastPoint: bool
    ChangeLowerTolerance: bool
    ChangeOffsetDistance: bool
    ChangeRetractDistance: bool
    ChangeStartPoint: bool
    ChangeTipNumber: bool
    ChangeToleranceValue: bool
    ChangeUpperTolerance: bool
    CreateEntryPoint: bool
    CreateExitPoint: bool
    HeightAboveFeature: float
...
class InspectionFeatureDataFilterBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def SetSpikeEliminationStdDev(self, multiplier: float) -> None:
        ...
    def SetMinimumPassValue(self, passValue: float) -> None:
        ...
    def SetMaximumPassValue(self, passValue: float) -> None:
        ...
    DataFilter: CAM.InspectionMethodBuilder.DataFilterTypes
    DataFilterFunction: CAM.InspectionMethodBuilder.DataFilterFunctionTypes
    DataFilterMaxPassValueBuilder: CAM.InheritableDoubleBuilder
    DataFilterMinPassValueBuilder: CAM.InheritableDoubleBuilder
    DataFilterPass: CAM.InspectionMethodBuilder.DataFilterPassTypes
    SpikeElimination: CAM.InspectionMethodBuilder.SpikeEliminationTypes
    SpikeEliminationStdDevBuilder: CAM.InheritableDoubleBuilder
...
class InspectionCircularMoveToPointBuilder(CAM.InspectionMoveBuilder):
    def __init__(self) -> None: ...
    AxisVector: Direction
    CenterPoint: Point
    EndPoint: Point
    MotionEnd: CAM.InspectionCircularMoveToPointBuilder.EndType
    SweepAngle: float
...
class InheritableLengthDepBuilder(CAM.InheritableDoubleBuilder):
    def __init__(self) -> None: ...
    Intent: CAM.LengthIntent
...
class InheritableDoubleBuilder(CAM.InheritableBuilder):
    def __init__(self) -> None: ...
    def HasExpressionString(self) -> bool:
        ...
    ExpressionString: str
    Value: float
    ValueIntent: CAM.ValueIntent
...
class InfillOrder(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.InfillOrder.Types
...
class IncludeFinishPass(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.IncludeFinishPass.Types
...
class HolderSectionBuilder(TaggedObject):
    ...
    def GetAllParameters(self, section: NXObject, lowerDiameter: float, length: float, taperAngle: float, upperDiameter: float, cornerRadius: float) -> None:
        ...
    def RetrieveStepsFromSolid(self) -> None:
        ...
    def SetSelectedBodies(self, bodies: typing.List[NXObject]) -> None:
        ...
    MountingCsys: NXObject
    NumberOfSections: int
...
class GuidedCurveBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def SelectCurveAutomatically(self) -> None:
        ...
    def ValidateCurves(self, sectionTag: Section, bridgeCurves: typing.List[ICurve]) -> None:
        ...
    def Validate(self) -> bool:
        ...
...
class GougeCheckResults(TransientObject):
    ...
    def GetHolderCollisionPoints(self) -> typing.List[Point3d]:
        ...
    GougeCheckStatus: CAM.GougeCheckResults.Status
...
class GougeCheckBuilder(Builder):
    def __init__(self) -> None: ...
    CheckGouge: bool
    CheckIpwCollision: bool
    CheckPartCollision: bool
...
class GeometryGroup(CAM.Geometry):
    def __init__(self) -> None: ...
    def ResetBlockSize(self) -> None:
        ...
    def ResetCylinderSize(self) -> None:
        ...
    ...
    BlankCreationType: CAM.GeometryGroup.BlankCreationTypes
    BlankDefinitionType: CAM.GeometryGroup.BlankDefinitionTypes
    BlankIpw: CAM.BlankIpw
    BlankIpwMultipleSource: CAM.BlankIpwMultipleSource
    BlankToggleValue: bool
    BlockHeight: float
    BlockLength: float
    BlockOffsetXNegative: float
    BlockOffsetXPositive: float
    BlockOffsetYNegative: float
    BlockOffsetYPositive: float
    BlockOffsetZNegative: float
    BlockOffsetZPositive: float
    BlockWidth: float
    Csys: CartesianCoordinateSystem
    CylinderDiameter: float
    CylinderHeight: float
    CylinderInheritAttributes: bool
    CylinderNegativeHeightOffset: float
    CylinderPositiveHeightOffset: float
    ...
    class BlankCreationTypes(enum.Enum):
        Body = 0
        Component = 1
...
class GeodesicType(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.GeodesicType.Options
...
class FusedDepositionToolBuilder(CAM.LaserTool):
    def __init__(self) -> None: ...
    ExtrusionDiameter: CAM.InheritableDoubleBuilder
    MaxBeadHeight: CAM.InheritableDoubleBuilder
    MaxBeadWidth: CAM.InheritableDoubleBuilder
    MaxExtrusionRate: CAM.InheritableDoubleBuilder
    MinBeadHeight: CAM.InheritableDoubleBuilder
    MinBeadWidth: CAM.InheritableDoubleBuilder
    MinExtrusionRate: CAM.InheritableDoubleBuilder
    OrificeDiameter: CAM.InheritableDoubleBuilder


class FoundationGeometry(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.FoundationGeometry.Types
...
class FlipMaterialSideBuilder(TaggedObject):
    def __init__(self) -> None: ...
    MaterialSideReversed: bool
...
class FinishPassesRough(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.FinishPassesRough.Types
...
class FinishPassControl(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.FinishPassControl.Types
...
class FeedsTurnBuilder(TaggedObject):
    def __init__(self) -> None: ...
    AutomaticFeedRateComputationState: bool
    ChamferFeed: CAM.InheritableFeedBuilder
    ChipThickness: CAM.InheritableDoubleBuilder
    CornerFeedRatesState: bool
    ...
    FeedRateConcaveCorner: CAM.InheritableFeedBuilder
    FeedRateConvexCorner: CAM.InheritableFeedBuilder
    FeedRetractBuilder: CAM.InheritableFeedBuilder
    FeedReturnBuilder: CAM.InheritableFeedBuilder
    FeedSideCutBuilder: CAM.InheritableFeedBuilder
    FeedStepoverBuilder: CAM.InheritableFeedBuilder
    ...
    MaximumFeedRateFromChipThickness: CAM.InheritableFeedBuilder
...
class FeedsOptimizationData(TaggedObject):
    ...
    OptimizationMethod: CAM.FeedsOptimizationData.OptimizationMethods
    PercentLowerLimit: float
    PercentUpperLimit: float


    class OptimizationMethods(enum.Enum):
...
class FeatureProcessBuilder(Builder):
    ...
    def CreateFeatureProcesses(self, features: typing.List[CAM.CAMFeature], resultStatus: FeatureProcessBuilderStatus) -> typing.List[CAM.Operation]:
        ...
    def CreateFeatureProcesses(self, groups: typing.List[CAM.FeatureGeometryGroup], resultStatus: FeatureProcessBuilderStatus) -> typing.List[CAM.Operation]:
        ...
...
class FbmEngineBuilder(Builder):
    def __init__(self) -> None: ...


class FacingZigZagBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...


class FacingBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...
...
class ExpressionString(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    Expression: str
    Intent: CAM.ParamValueIntent
    Value: str
...
class ExpressionInteger(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    Expression: str
    Intent: CAM.ParamValueIntent
    Value: int
...
class ElementVectorBuilder(TaggedObject):
    def __init__(self) -> None: ...
    Vector: Direction
...
class ElementPointBuilder(TaggedObject):
    def __init__(self) -> None: ...
    Point: Point
...
class EdgeChamferBuilder(CAM.MillOperationBuilder):
    def __init__(self) -> None: ...


class EdgeAlignment(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.EdgeAlignment.Types
...
class DriveGeometry(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.DriveGeometry.Types
...
class DriveAccuracy(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.DriveAccuracy.Types
...
class DmSurfBuilder(TaggedObject):
    ...
    SurfacePercentageEndFirstValue: float
    SurfacePercentageEndLastValue: float
    SurfacePercentageEndStepValue: float
    SurfacePercentageStartFirstValue: float
    SurfacePercentageStartLastValue: float
    SurfacePercentageStartStepValue: float
...
class DivideStepover(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.DivideStepover.Types


    class Types(enum.Enum):
        Equalize = 0
        ConstantAtMaximum = 1
        ConstantWithEqualize = 2
        EqualizeFromMinimum = 3
        EqualizeFromMaximum = 4
...
class DepositionWidth(CAM.InheritableIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.DepositionWidth.Types


    class Types(enum.Enum):
        FixedEffectiveWidth = 0
        CalculatedWidth = 1
    

class DepositionOnStepover(CAM.InheritableIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.DepositionOnStepover.Types
...
class CylinderMillingBuilder(CAM.CylindricalMillingBuilder):
    ...
    MotionOutput: CAM.CylinderMillingBuilder.MotionOutputTypes
    OffsetFromStartDiameter: CAM.InheritableToolDepBuilder
...
class CutPattern(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.CutPattern.Types
    ...
    class Types(enum.Enum):
        ...
        RadialZig = 12
        RadialZigContour = 13
        RadialZigStepover = 14
        ConcentricZigZag = 15
        ConcentricZig = 16
        ConcentricZigContour = 17
        ConcentricZigStepover = 18
        RadialZigZagLift = 19
        CrossZig = 20
        CrossZigZag = 21
        CrossZigZagLift = 22
...
class CutParametersTrimBehaviorTypes(enum.Enum):
    Default = 0
    NcmTrimmed = 1
    FollowBoundary = 2
...
class CutDirectionOption(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.CutDirectionOption.Types
...
class CustomParameterSetList(TaggedObject):
    def __init__(self) -> None: ...
    def Append(self, objects: typing.List[CAM.CustomParameterSet]) -> None:
        ...
    def Append(self, object: CAM.CustomParameterSet) -> None:
        ...
    def ClearIndex(self, deleteIdx: int) -> None:
        ...
    def FindIndex(self, obj: CAM.CustomParameterSet) -> int:
        ...
    def FindItem(self, index: int) -> CAM.CustomParameterSet:
        ...
    def Erase(self, index: int) -> None:
        ...
    def Erase(self, index: int, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Erase(self, obj: CAM.CustomParameterSet) -> None:
        ...
    def Erase(self, obj: CAM.CustomParameterSet, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Clear(self) -> None:
        ...
    def Clear(self, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def GetContents(self) -> typing.List[CAM.CustomParameterSet]:
        ...
    def SetContents(self, objects: typing.List[CAM.CustomParameterSet]) -> None:
        ...
    def Swap(self, index1: int, index2: int) -> None:
        ...
    def Swap(self, object1: CAM.CustomParameterSet, object2: CAM.CustomParameterSet) -> None:
        ...
    def Insert(self, location: int, object: CAM.CustomParameterSet) -> None:
        ...
    def MoveToTop(self, index: int) -> None:
        ...
    def MoveToBottom(self, index: int) -> None:
...
class CustomParameterSet(CAM.Ude):
    def __init__(self) -> None: ...


class CustomParameterDataSetList(CAM.UdeParameter):
    def __init__(self) -> None: ...
    def CreateCustomParameterSet(self) -> CAM.CustomParameterSet:
        ...
    Jalist: CAM.CustomParameterSetList


class CustomNcmClearanceBuilder(TaggedObject):
    def __init__(self) -> None: ...
    Axis: NXObject
    Body: NXObject
    BoundingBoxClearance: float
    ClearanceType: CAM.CustomNcmClearanceBuilder.ClearanceTypes
    PlaneXform: Plane
    Point: NXObject
    Radius: float
    SafeDistance: float
...
class CustomCurveListBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def CreateCurve(self, section: Section) -> CAM.CurveItemBuilder:
        ...
    def CreateAutomaticCurves(self, distanceTolerance: float, chainingTolerance: float, angleTolerance: float, tagArray: typing.List[NXObject]) -> None:
        ...
    def Validate(self) -> bool:
        ...
    Curves: CAM.CurveItemBuilderList


class CurveListBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def CreateCurve(self, section: Section) -> CAM.CurveItemBuilder:
        ...
    def Validate(self) -> bool:
...
class CurveItemBuilderList(TaggedObject):
    def __init__(self) -> None: ...
    def Append(self, objects: typing.List[CAM.CurveItemBuilder]) -> None:
        ...
    def Append(self, object: CAM.CurveItemBuilder) -> None:
        ...
    def ClearIndex(self, deleteIdx: int) -> None:
        ...
    def FindIndex(self, obj: CAM.CurveItemBuilder) -> int:
        ...
    def FindItem(self, index: int) -> CAM.CurveItemBuilder:
        ...
    def Erase(self, index: int) -> None:
        ...
    def Erase(self, index: int, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Erase(self, obj: CAM.CurveItemBuilder) -> None:
        ...
    def Erase(self, obj: CAM.CurveItemBuilder, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Clear(self) -> None:
        ...
    def Clear(self, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def GetContents(self) -> typing.List[CAM.CurveItemBuilder]:
        ...
    def SetContents(self, objects: typing.List[CAM.CurveItemBuilder]) -> None:
        ...
    def Swap(self, index1: int, index2: int) -> None:
        ...
    def Swap(self, object1: CAM.CurveItemBuilder, object2: CAM.CurveItemBuilder) -> None:
        ...
    def Insert(self, location: int, object: CAM.CurveItemBuilder) -> None:
        ...
    def MoveToTop(self, index: int) -> None:
        ...
    def MoveToBottom(self, index: int) -> None:
...
class CurveItemBuilder(Builder):
    def __init__(self) -> None: ...
    CurveItem: Section


class CurveBuilder(TaggedObject):
    def __init__(self) -> None: ...
    def CreateCentralCurve(self) -> None:
        ...
    def Validate(self) -> bool:
        ...
    CentralCurve: Section


class CreateTool(Builder):
    def __init__(self) -> None: ...
    def GetFeature(self) -> CAM.CAMFeature:
        ...
    def SetFeature(self, feature: CAM.CAMFeature) -> None:
        ...
    def GetTopDepthOffset(self) -> float:
        ...
    def SetTopDepthOffset(self, offset: float) -> None:
        ...
    def GetBottomDepthOffset(self) -> float:
        ...
    def SetBottomDepthOffset(self, offset: float) -> None:
        ...
    def GetDepthOffset(self, index: int) -> float:
        ...
    def SetDepthOffset(self, index: int, offset: float) -> None:
        ...
    def GetDiameterOffset(self, index: int) -> float:
        ...
    def SetDiameterOffset(self, index: int, offset: float) -> None:
        ...
    def GetDepthRange(self) -> float:
        ...
    def SetDepthRange(self, tolerance: float) -> None:
        ...
    def GetDiameterRange(self) -> float:
        ...
    def SetDiameterRange(self, tolerance: float) -> None:
        ...
    def GetMachiningAreaNames(self) -> str:
        ...
    def GetMachiningAreaActive(self, index: int) -> bool:
        ...
    def SetMachiningAreaActive(self, index: int, value: bool) -> None:
        ...
    def GetToolClass(self) -> str:
        ...
    def SetToolClass(self, name: str) -> None:
        ...
    def GetToolTemplate(self) -> str:
        ...
    def SetToolTemplate(self, name: str) -> None:
        ...
    def GetLibTools(self) -> str:
        ...
    def GetMacTools(self) -> typing.List[CAM.Tool]:
        ...
    def CreateNewTool(self) -> CAM.Tool:
        ...
    MatchDepthOption: bool
    TopDiameter: float


class CornerMarker(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.CornerMarker.Types


    class Types(enum.Enum):
        Off = 0
        MarkOnly = 1
        ReplaceCornersWithNonCuttingMoves = 2
...
class ContactMoveBuilder(CAM.MoveBuilder):
    def __init__(self) -> None: ...
    MoveContainer: CAM.ObjectContainer
    ToolSideDirection: CAM.ContactMoveBuilder.ToolSide


    class ToolSide(enum.Enum):
        Left = 0
        Right = 1
    

class ComparePartsResult(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    def GetComparedObjects(self, object1: CAM.CAMObject, object2: CAM.CAMObject) -> None:
        ...
    def GetIsCustomizationDifferent(self) -> bool:
        ...
    def GetIsValueDifferent(self) -> bool:
        ...
    def GetTypeOfObject(self) -> CAM.ComparePartsResult.ObjectTypes:
        ...
    ...
    class ObjectTypes(enum.Enum):
        ...
        TaskViewObject = 1
        MethodViewObject = 2
        GeometryViewObject = 3
        MachineViewObject = 4
    

class CompareParts(TransientObject):
    def __init__(self, ptr: int) -> None: ...
    def FreeResource(self) -> None:
        ...
    def Compare(self, comparePartsResult: typing.List[CAM.ComparePartsResult]) -> None:
        ...
    def GetMismatchedObjects(self, addedOrDeleted: CAM.CompareParts.ObjectStatus, addedObjects: typing.List[CAM.CAMObject], type: typing.List[CAM.CompareParts.ObjectTypes]) -> None:
        ...
...
class CmmProbingBuilder(CAM.OperationBuilder):
    def __init__(self) -> None: ...
    def ShowInspectGeometry(self) -> None:
        ...
    def AddTolerance(self) -> CAM.Operation:
        ...
    def DeleteTolerance(self, selectedObject: CAM.Operation) -> None:
        ...
    def DeleteFeature(self, selectedObject: CAM.Operation) -> None:
        ...
    ...
    def ProcessSelectedGeometry(self) -> None:
        ...
    def ProcessSelectedPMI(self) -> None:
        ...
    def ProcessGeometryGroup(self, add: bool, objects: typing.List[CAM.CAMObject]) -> None:
        ...
    def ChangeGeometryGroup(self) -> bool:
        ...
    def ChangeMethod(self) -> None:
        ...
    def EditEntryExitPoints(self) -> None:
        ...
    def EditStartEndPoints(self) -> None:
        ...
    FeatureBaseName: str
    InspectGeometryMask: int
    PathType: CAM.CmmProbingBuilder.InspectionPathType
    QuickTolerance: str
    SelectInspectGeometry: SelectNXObjectList
    SelectPMI: SelectNXObjectList


    class InspectionPathType(enum.Enum):
        TouchPoint = 0
        Scan3Axis = 1
        Scan5Axis = 2
...
class CarbonFiberToolBuilder(CAM.LaserTool):
    def __init__(self) -> None: ...
    TapeWidth: CAM.InheritableDoubleBuilder
    TrimToExtruder: CAM.InheritableDoubleBuilder
...
class CAMSetup(CAM.CAMObject):
    ...
    def PostprocessWithSetting(self, objects: typing.List[CAM.CAMObject], machineType: str, outfileName: str, outputUnits: CAM.CAMSetup.OutputUnits, outputWarning: CAM.CAMSetup.PostprocessSettingsOutputWarning, reviewTool: CAM.CAMSetup.PostprocessSettingsReviewTool) -> None:
        ...
    def PostprocessWithPostprocessor(self, objects: typing.List[CAM.CAMObject], eventHandlerFile: str, definitionFile: str, outfileName: str, outputUnits: CAM.CAMSetup.OutputUnits, outputWarning: CAM.CAMSetup.PostprocessSettingsOutputWarning, reviewTool: CAM.CAMSetup.PostprocessSettingsReviewTool) -> None:
        ...
    def PostprocessWithPostModeSetting(self, objects: typing.List[CAM.CAMObject], machineType: str, outfileName: str, outputUnits: CAM.CAMSetup.OutputUnits, outputWarning: CAM.CAMSetup.PostprocessSettingsOutputWarning, reviewTool: CAM.CAMSetup.PostprocessSettingsReviewTool, postMode: CAM.CAMSetup.PostprocessSettingsPostMode) -> None:
        ...
    def CutObjects(self, view: CAM.CAMSetup.View, objectsToBeMoved: typing.List[CAM.CAMObject]) -> None:
        ...
    def MoveObjects(self, view: CAM.CAMSetup.View, objectsToBeMoved: typing.List[CAM.CAMObject], destinationObject: CAM.CAMObject, pastePosition: CAM.CAMSetup.Paste) -> None:
    ...
    def CustomizationUpdateFromObject(self, destinationObject: CAM.CAMObject, sourceObject: CAM.CAMObject) -> None:
        ...
    def OpenPartToCustomizeFrom(self, partName: str) -> Part:
        ...
    ...
    def DeleteVnckMachineData(self) -> None:
        ...
        ...
    def ResetVirtualControllerData(self) -> None:
        ...
    ...
    def CopyFromComponent(self) -> None:
        ...
    def CreateTransitionPath(self, nctask: CAM.NCGroup, selectedObjects: typing.List[CAM.CAMObject], editedOperations: typing.List[CAM.Operation]) -> None:
        ...
    def UpdateTransitionPath(self, nctask: CAM.NCGroup, selectedObjects: typing.List[CAM.CAMObject], editedOperations: typing.List[CAM.Operation]) -> None:
        ...
    def DeleteTransitionPath(self, nctask: CAM.NCGroup) -> None:
        ...
    def DeleteOperationTransitionPath(self, param: CAM.Operation) -> None:
        ...
    def DisplayIpwWithPickOnPath(self, objects: typing.List[CAM.CAMObject]) -> None:
        ...
    def Display2dIpwWithPickOnPath(self, display: bool) -> None:
        ...
    def DeleteIpwWithPickOnPath(self) -> None:
        ...
    def ApplyRoboticRules(self, pOperations: typing.List[CAM.CAMObject], askForValidation: bool, doNotShowSuccessMessages: bool) -> int:
        ...
    def ValidateRoboticPaths(self, pOperations: typing.List[CAM.CAMObject], checkForCollisions: bool, displayFindings: bool) -> None:
        ...
    def CalculateMachiningTimes(self) -> None:
        ...
    def DeleteMachineCode(self) -> None:
        ...
    def CreateToolFromFeature(self, param: CAM.CAMObject) -> CAM.CreateTool:
        ...
    def PostprocessMultichannel(self, objects: typing.List[CAM.CAMObject], outfileName: str) -> None:
        ...
    def CalculateProcessForces(self, objects: typing.List[CAM.CAMObject]) -> None:
        ...
    def CreateFixtureBuilder(self, subType: CAM.CAMSetup.FixtureSubtype, body: Body, filePath: str) -> CAM.FixtureBuilder:
        ...
    def FindObjectByName(self, sid: str) -> CAM.CAMObject:
        ...
    def CreateToolPathRulesBuilder(self, pathOwner: CAM.CAMObject) -> CAM.ToolPathRulesBuilder:
        ...
    def CreateFbmEngineBuilder(self) -> CAM.FbmEngineBuilder:
        ...
    def CreateToolpathGenerateBuilder(self, objectsToGenerate: typing.List[CAM.CAMObject]) -> CAM.ToolpathGenerateBuilder:
        ...
    def CreateToolPathValidator(self, path: CAM.Path) -> CAM.PathValidator:
        ...
    def MinimumToolLength(self, objects: typing.List[CAM.CAMObject], checkedObjects: typing.List[CAM.CAMObject], errorCode: int, minLengths: float) -> None:
        ...
    ...
    class PostprocessSettingsPostMode(enum.Enum):
        Normal = -1
        AdvancedAuto = 0
        AdvancedRegenerate = 1
        AdvancedReuse = 2
    ...
    class FixtureSubtype(enum.Enum):
        Default = 0
        Vise = 1
        Chuck = 2
...
class CAMSession(Utilities.NXRemotableObject):
    ...
    def GetDialogCustomization(self, paramObj: CAM.CAMObject, itemIds: int, itemLabels: str) -> None:
        ...
    def SetDialogCustomization(self, paramObj: CAM.CAMObject, itemIds: int, itemLabels: str) -> None:
        ...
    def AddTemplateType(self, templatePartWithLocation: str) -> None:
        ...
    def Tag(self) -> Tag: ...
...
class CAMObject(NXObject):
    ...
    def DeleteMasterPath(self) -> None:
        ...
    def DeleteToolPath(self) -> None:
        ...
    def GetNameOfType(self) -> str:
        ...
    def GetValidationResult(self, validationType: CAM.CAMObject.ValidationType) -> CAM.CAMObject.ValidationResult:
        ...


    class ValidationType(enum.Enum):
        Gouge = 1
        ToolHolderCollision = 2
        ToolRapidCollision = 3
        HasPath = 4
        SuspectPath = 5
        FeedsSpeeds = 6
    ...
    class Attr(enum.Enum):
        ...
        PredefinedDepthConversionProblem = 11
...
class BoundarySet(TaggedObject):
    ...
    def CreateBoundaryMemberSet(self) -> CAM.BoundaryMemberSet:
        ...
    def SynchronizePlanes(self, sourceSet: CAM.BoundarySet) -> None:
        ...
...
class BoundaryPlanarMill(CAM.Boundary):
    ...
    def AppendFaceBoundary(self, face: TaggedObject, ignoreHole: bool, ignoreIsland: bool, ignoreChamfer: bool, toolSide: CAM.BoundarySet.ToolSideTypes, convexEdges: int, concaveEdges: int) -> typing.List[CAM.BoundarySet]:
        ...
    InitialToolPosition: CAM.BoundaryPlanarMill.ToolPositionTypes
...
class BoundaryInnerWireEDM(CAM.Boundary):
    def __init__(self) -> None: ...
...
class BlankIpwSetList(TaggedObject):
    def __init__(self) -> None: ...
    def Append(self, objects: typing.List[CAM.BlankIpwSet]) -> None:
        ...
    def Append(self, object: CAM.BlankIpwSet) -> None:
        ...
    def ClearIndex(self, deleteIdx: int) -> None:
        ...
    def FindIndex(self, obj: CAM.BlankIpwSet) -> int:
        ...
    def FindItem(self, index: int) -> CAM.BlankIpwSet:
        ...
    def Erase(self, index: int) -> None:
        ...
    def Erase(self, index: int, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Erase(self, obj: CAM.BlankIpwSet) -> None:
        ...
    def Erase(self, obj: CAM.BlankIpwSet, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def Clear(self) -> None:
        ...
    def Clear(self, deleteOption: ObjectList.DeleteOption) -> None:
        ...
    def GetContents(self) -> typing.List[CAM.BlankIpwSet]:
        ...
    def SetContents(self, objects: typing.List[CAM.BlankIpwSet]) -> None:
        ...
    def Swap(self, index1: int, index2: int) -> None:
        ...
    def Swap(self, object1: CAM.BlankIpwSet, object2: CAM.BlankIpwSet) -> None:
        ...
    def Insert(self, location: int, object: CAM.BlankIpwSet) -> None:
        ...
    def MoveToTop(self, index: int) -> None:
        ...
    def MoveToBottom(self, index: int) -> None:
...
class BlankIpwSet(TaggedObject):
    def __init__(self) -> None: ...
    def SetSource(self, sourcePartName: str, sourceName: str) -> None:
        ...
    def GetSource(self, sourcePart: NXObject) -> CAM.CAMObject:
        ...
    def GetStatus(self) -> CAM.BlankIpwSet.StatusTypes:
        ...
    def Update(self) -> CAM.BlankIpwSet.StatusTypes:
        ...
    def IsValidSource(self, obj: CAM.CAMObject) -> bool:
        ...
    IpwPositionCsys: CoordinateSystem
    PositionType: CAM.BlankIpwSet.PositionTypes
...
class BlankIpwMultipleSource(TaggedObject):
    def __init__(self) -> None: ...
    def Update(self) -> CAM.BlankIpwMultipleSource.StatusTypes:
        ...
    def CreateBlankIpwSet(self) -> CAM.BlankIpwSet:
        ...
    def GetStatus(self) -> CAM.BlankIpwMultipleSource.StatusTypes:
        ...
    AdditionalGeometryCollector: ScCollector
    SetList: CAM.BlankIpwSetList
...
class BladeStepOver(TaggedObject):
    def __init__(self) -> None: ...
    NumberOfCutsPerDepth: int
    NumberOfIntermediateDepths: int
    PassesType: CAM.BladeStepOver.BladePassesType
    PercentOfInfillStepOver: float


    class BladePassesType(enum.Enum):
        OnFirstCut = 0
        OnTwoCuts = 1
        OnMultipleCuts = 2
        OnNone = 3
...
class BladeSideEntry(TaggedObject):
    def __init__(self) -> None: ...
    SideEntryEndFirstU: float
    SideEntryEndLastU: float
    SideEntryEndStepV: float
    SideEntryFlareRange: float
    SideEntryFlaresMaxStock: float
    SideEntryGuideCurveFromV: float
    SideEntryStartFirstU: float
    SideEntryStartLastU: float
    SideEntryStartStepV: float
...
class BladeGeometryType(TaggedObject):
    def __init__(self) -> None: ...
    BladeGeometryFiveaxisType: CAM.BladeGeometryType.GeometryType


    class GeometryType(enum.Enum):
        Impeller = 0
        BliskRotational = 1
        BliskNonrotational = 2
    

class BladeFinishPass(TaggedObject):
    def __init__(self) -> None: ...
    ApplyStockOffsetOnBothSides: bool
    AxialShiftForFinishPasses: float
    FinishPasses: CAM.BladeFinishPass.BladeFinishPassesType
    MultipleDepths: CAM.BladeFinishPass.FinishPassesMultipleDepthsType
    NumberOfDepths: int
    NumberOfFinishPasses: int
    OutputType: CAM.BladeFinishPass.FinishPassesOutputType
    SideStockOffset: CAM.InheritableToolDepBuilder


    class FinishPassesOutputType(enum.Enum):
        InfillsOnly = 0
        FinishPassesOnly = 1
        InfillsAndFinishPasses = 2
    

    class FinishPassesMultipleDepthsType(enum.Enum):
        None = 0
        AlongToolAxis = 1
        AlongContact = 2
    

    class BladeFinishPassesType(enum.Enum):
        None = 0
        LeftAndRight = 1
        Left = 2
        Right = 3
...
class Blade(TaggedObject):
    def __init__(self) -> None: ...
    BladeFinishPass: CAM.BladeFinishPass
    BladeSideEntry: CAM.BladeSideEntry
    BladeStepOver: CAM.BladeStepOver
...
class BeadContainment(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.BeadContainment.Types
...
class BarrelToolBuilder(CAM.MillingToolBuilder):
    ...
    WorkingAngle: CAM.InheritableDoubleBuilder


class AxisMoveBuilder(CAM.BaseBuilder):
    def __init__(self) -> None: ...
    Length: float
    Limit: CAM.AxisMoveBuilder.JaCamAxisMoveLimitTypes
    ...
    class JaCamAxisMoveLimitTypes(enum.Enum):
        UpperSoftLimit = 0
        LowerSoftLimit = 1
        UpperLimit = 2
        LowerLimit = 3
...
class AvoidanceTiltAdjustment(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.AvoidanceTiltAdjustment.Types
...
class AvoidancePreferredRotation(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.AvoidancePreferredRotation.Types
...
class AvoidancePreferredLead(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.AvoidancePreferredLead.Types
...
class AvoidanceMethodsBuilder(CAM.BaseBuilder):
    def __init__(self) -> None: ...
...
class AvoidanceDirection(CAM.ElementIntBuilder):
    def __init__(self) -> None: ...
    EnumValue: CAM.AvoidanceDirection.Types
...
class AngularAboutAxisMoveBuilder(CAM.MoveBuilder):
    ...
    Intent: CAM.AngularAboutAxisMoveBuilder.MoveIntent
...
class AlongMachineAxisMoveBuilder(CAM.MoveBuilder):
    ...
    COutput: bool
    FifthAxisRotaryDirection: CAM.AlongMachineAxisMoveBuilder.RotaryDirectionType
    FourthAxisRotaryDirection: CAM.AlongMachineAxisMoveBuilder.RotaryDirectionType
    MachineMoveAxis: CAM.AlongMachineAxisMoveBuilder.MachineMoveAxisType
    RotarySolution: CAM.AlongMachineAxisMoveBuilder.RotarySolutionType
    ToolCenterPointControl: CAM.AlongMachineAxisMoveBuilder.ToolCenterPointControlType
    XAxis: float
    ...
    class ToolCenterPointControlType(enum.Enum):
        MoveAxisOnly = 0
        KeepTooltipPosition = 1
    

    class RotarySolutionType(enum.Enum):
        Default = 0
        Alternative = 1
    

    class RotaryDirectionType(enum.Enum):
        Standard = 0
        Reverse = 1
    

    class MachineMoveAxisType(enum.Enum):
        MachineAxis = 0
        CoordinateAxis = 1
