...
class RSEventParameters(TaggedObject):
    ...
    ConfidenceLevelOption: CAE.ResponseSimulation.RSEvent.ConfidenceLevelOption
    FrequencyOutputRequestObject: CAE.ModelingObjectPropertyTable
    OutputRequestObject: CAE.ModelingObjectPropertyTable
    RandomOutputRequestObject: CAE.ModelingObjectPropertyTable
    ReferenceType: CAE.ResponseSimulation.RSEvent.ReferenceType
    SineOutputRequestObject: CAE.ModelingObjectPropertyTable
    StandardDeviation: float
    StaticContributions: bool
...
class RSEventBuilder(CAE.ResponseSimulation.BaseBuilder):
    ...
    EventParameters: CAE.ResponseSimulation.RSEventParameters
...
class ResponseResultsEvaluationSettingBuilder(CAE.ResponseSimulation.DynamicResultEvaluationSettingBuilder):
    ...
    SpringForceEvaluationFromDisplacement: bool
    StartPoint: float
...
class NodalFunctionExcitationBuilder(CAE.ResponseSimulation.ExcitationBuilder):
    def __init__(self) -> None: ...
    FrequencyRangeLowerBound: float
    FrequencyRangeUpperBound: float
    InheritFrequencyRangeFromFunction: bool
    InitialAccelerationX: Expression
    InitialAccelerationY: Expression
    InitialAccelerationZ: Expression
    InitialDisplacementX: Expression
    InitialDisplacementY: Expression
    InitialDisplacementZ: Expression
    InitialUserDefDirAcceleration: Expression
    InitialUserDefDirDisplacement: Expression
    InitialUserDefDirVelocity: Expression
    InitialVelocityX: Expression
    InitialVelocityY: Expression
    InitialVelocityZ: Expression
    UserSpecifiedInitialExcitationConditionsToggle: bool
...
class ExcitationLocationDefinition(TaggedObject):
    ...
    ExcitationLocationlist: SelectTaggedObjectList
