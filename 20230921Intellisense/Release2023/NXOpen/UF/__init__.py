...
class Util(System.Object):
    ...
    def GetLocaleEncoding(self) -> None:
        ...
    def DeleteList(self, list: int) -> int:
        ...
...
class UTF8TextMode(System.Object):
    def __init__(self) -> None: ...
...
class UnitMeasureType(enum.Enum):
    ...
    MeasureElectricalConductivity = 106
    MeasurePowerToMassRatio = 107
    MeasureElectricalCapacitance = 108
    MeasureFrequencySquared = 109
    MeasurePerAngle = 110
    MeasurePerAngleSquared = 111
    MeasureFrequencyCubed = 112
    MeasureMassMomentInertiaPerAngle = 113
    MeasureMagneticConductivity = 114
    MeasureMagneticFlux = 115
    MeasureMagneticVectorPotential = 116
    MeasureVolumeChargeDensity = 117
    MeasureApparentPower = 118
    MeasureEnergyContent = 119
    MeasureVolumetricStrain = 120
    MeasureVolumeAcceleration = 121
    MeasureCount = 122
    MeasureCustom = 5000
...
class UFWeld(Utilities.NXRemotableObject):
    ...
    class UFWeld_SpotInfo():
        spot_point: Tag
        face_loc: int
    

    class UFWeld_SpotFaceLoc():
        face_tag: Tag
        point: float
        face_normal: float
        face_handle: int
...
class UFWeight(Utilities.NXRemotableObject):
    ...
    class ExceptionReason(enum.Enum):
        ...
        HasSelfIntersectingBody = 21
        RefSetMismatch = 22
        ExpressionAbsent = 23
        AttributeAbsent = 24
        RollupAttrOutOfDate = 25
        RollupExpOutOfDate = 26
        AssertionWithValueSourceAbsent = 27
    

    class UFWeight_Exceptions1():
        n_exceptions: int
        reasons: int
        part_names: int
        comp_names: int
...
class UFWave(Utilities.NXRemotableObject):
    ...
    class UFWave_LinkedFeatureInfo():
        feature_name: int
        owning_part_name: int
        source_part_name: int
...
class UFView(Utilities.NXRemotableObject):
    ...
    class UFView_Lighting():
        two_sided_light: int
        shininess: float
        light_count: int
        lights: typing.List[UF.UFView._Lights]
...
class UFUi(Utilities.NXRemotableObject):
    ...
    class DialogFilterId(enum.Enum):
        ...
        TranCatiaFltr = 80
        TranCatmodFltr = 81
        CaeRptTemplatesFltr = 82
        CaeRptImgFltr = 83
        InteropFltr = 84
        DraftingImageFltr = 85
        Nx2dFltr = 86
        SprdFltr = 87
        SprdntFltr = 88
        SprshtFltr = 89
        ...
        CaeOp2Fltr = 97
        TranCatiav5Fltr = 98
        TranCatiav5CatpartFltr = 99
        ImportAcFltr = 100
        PrtPartOpenFltr = 101
        SfemPartOpenFltr = 102
        FemPartOpenFltr = 103
        FemPartNewFltr = 104
        BookmarkOpenFltr = 105
        BookmarkSaveFltr = 106
        CaeAfuFltr = 107
        XyplotDispTemplateFltr = 108
        FemSaveasFltr = 109
        SimSaveasFltr = 110
        MotionImpExpFltr = 111
        FtkNavTreeHistoryFltr = 112
        SimPartNewFltr = 113
        SimPartOpenFltr = 114
        FaceAnalysisReflectionFltr = 115
        BackgroundImageFltr = 116
        TextureImageFltr = 117
        IblImageFltr = 118
        CaeRpciiiFltr = 119
        CaeDacFltr = 120
        CaeCsvFltr = 121
        ...
        CaeSefFltr = 126
        CaeRs2Fltr = 127
        CamFeaExportFltr = 128
        CaeMatFltr = 129
        MotionAdamsResFltr = 130
        MotionRecurdynRadFltr = 131
        PdfFltr = 132
        JpgFltr = 133
        TifFltr = 134
        EmfFltr = 135
        PngFltr = 136
        CaeUnv58Fltr = 137
        AssyFemPartOpenFltr = 138
        AssyFemPartNewFltr = 139
        AssyFemSaveasFltr = 140
        IfemPartOpenFltr = 141
        KfMisc1Fltr = 142
        KfMisc2Fltr = 143
        KfMisc3Fltr = 144
        KfMisc4Fltr = 145
        ...
        SimulinkMdlFltr = 147
        SimulinkMFltr = 148
        MotionExportSdkRmdFltr = 149
        StandardFontsFltr = 150
        SwPartAsmFltr = 151
        IgesExportFltr = 152
        StepExportFltr = 153
        MotionFlexbodyRfiFltr = 154
        ImageFileFltr = 155
        AttrCatalogFltr = 156
        MwFltr = 157
        TrumpfGeoFltr = 158
        TireSpindleFltr = 159
        StudioImageFileFltr = 160
        MotionRecurdynRadRanFltr = 161
        MechdesRuntimeCodeFltr = 162
        CaeUnvFltr = 163
        PaxFltr = 164
        Hdf5Fltr = 165
        LayupFltr = 166
        CaeBrowseFltr = 167
        CaeMdfFltr = 168
        PartSaveasWithCatproductFltr = 169
        TranCatiav5CatproductFltr = 170
        JtConfigFltr = 171
        CaeCondseqFltr = 172
        JpegFltr = 173
        JpeFltr = 174
        TiffFltr = 175
        RasterImageFltr = 176
        MotionLmsMresFltr = 177
        ReportTemplateFltr = 178
        ReportImagesFltr = 179
        ReportZipFltr = 180
        TranAcisImportFltr = 181
        TranAcisExportFltr = 182
        TranAcisSatFltr = 183
        TranAcisSabFltr = 184
        PodFltr = 185
        IrayplusMaterialFltr = 186
        IrayplusMaterialSystemSaveFltr = 187
        IrayplusMdlFltr = 188
        PsfFltr = 189
        DgmlFltr = 190
        TranStpxFltr = 191
        ...
        TranStp242Fltr = 194
        Tran3mfFltr = 195
        TranWavefrontObjFltr = 196
        TranIfcFltr = 197
        CaeLayoutstateFltr = 198
        MotionLmsLmsmotionresultsFltr = 199
        MotionLmsOffFltr = 200
        LightProfileFileFltr = 201
        CaeAppppDatasourceFltr = 202
        CaeResultsessionFltr = 203
        XmcfFltr = 204
        PartSaveasWithProtection = 205
        GifFltr = 206
        BmpFltr = 207
        XwdFltr = 208
        FieldImportFltr = 209
        XxmlFltr = 210
        CamCompanySetupImageFltr = 211
        CaeVl2tlFltr = 212
        FieldTableDataImportFltr = 213
        TranCatiav5CatshapeFltr = 214
        TranCatiav5CgrFltr = 215
        CaeRstImpFltr = 216
        CaeRstOdbImpFltr = 217
        TranStp242ExportFltr = 218
        MotionAutoflexImportNastranFileFltr = 219
        MotionMflxdbFltr = 220
        PnidImageFltr = 221
        XmlFltr = 222
        CaeResultsessionExportFltr = 223
        EmbedGuideFltr = 224
        EmbedDocFltr = 225
        EmbedAutoFltr = 226
        SaveLoadOptFltr = 227
        ImportJtFltr = 228
        ImportCsvTsvFltr = 229
        TdpTemplateImageFltr = 230
        TcinImportAssyFltr = 231
        CaeRstScd5ImpFltr = 232
        CaeRstOdbScd5ImpFltr = 233
        CaeRstScd5Fltr = 234
        CaeRstOdbScd5Fltr = 235
        MotionLmsMinfFltr = 236
        CaeAppppDatasourceScd5Fltr = 237
        SvmFltr = 238
        AxfFltr = 239
        IesFltr = 240
        VisioStencilFltr = 241
        SchematicLogicalModelFltr = 242
        NestAddpartFltr = 243
        DialogFilterCount = 244
    ...
    class DialogDirId(enum.Enum):
        ...
        CaeRs2Dir = 88
        CaeMatDir = 89
        ReportTemplateDir = 90
        ReportImagesDir = 91
        ReportZipDir = 92
        MotionAdamsResDir = 93
        MotionRecurdynRadDir = 94
        PdfDir = 95
        JpgDir = 96
        TifDir = 97
        EmfDir = 98
        ...
        SimulinkMdlDir = 107
        SimulinkMDir = 108
        MotionExportSdkRmdDir = 109
        StandardFontsDir = 110
        IgesExportDir = 111
        StepExportDir = 112
        MotionFlexbodyRfiDir = 113
        AttrCatalogDir = 114
        MwDir = 115
        TrumpfGeoDir = 116
        TireSpindleDir = 117
        MotionRecurdynRadRanDir = 118
        MechdesRuntimeCodeDir = 119
        CaeUnvDir = 120
        PaxDir = 121
        Hdf5Dir = 122
        LayupDir = 123
        CaeBrowseDir = 124
        CaeMdfDir = 125
        TranCatiav5CatproductDir = 126
        CaeCondseqDir = 127
        MotionLmsMresDir = 128
        CaeRstXdbDir = 129
        CaeRstXdbOdbDir = 130
        TranAcisDir = 131
        TranAcisSatDir = 132
        TranAcisSabDir = 133
        MotionFlexbodyOp2Dir = 134
        PodDir = 135
        DgmlDir = 136
        TranStpxDir = 137
        TranStpzDir = 138
        IrayplusMaterialDir = 139
        IrayplusMaterialSystemSaveDir = 140
        IrayplusMdlDir = 141
        TranStpxzDir = 142
        TranStp242Dir = 143
        Tran3mfDir = 144
        TranWavefrontObjDir = 145
        TranIfcDir = 146
        CaeLayoutstateDir = 147
        MotionLmsLmsmotionresultsDir = 148
        CaeAppppDatasourceDir = 149
        LightProfileFileDir = 150
        XmcfDir = 151
        CaeResultsessionDir = 152
        GifDir = 153
        BmpDir = 154
        XwdDir = 155
        FieldImportDir = 156
        XxmlDir = 157
        CamCompanySetupImageDir = 158
        CaeVl2tlDir = 159
        TranCatiav5CatshapeDir = 160
        TranCatiav5CgrDir = 161
        CaeRstImpDir = 162
        CaeRstOdbImpDir = 163
        MotionAutoflexImportNastranFileDir = 164
        MotionMflxdbFileDir = 165
        PnidImageDir = 166
        CaeResultsessionExportDir = 167
        EmbedDir = 168
        SvmDir = 169
        SvmSystemSaveDir = 170
        IesDir = 171
        SlmDir = 172
        DialogDirCount = 173
...
class UFUgmgr(Utilities.NXRemotableObject):
    ...
    class UFUgmgr_VariantConfiguration():
        product: bytes
        variant: bytes
        desc: bytes
    

    class UFUgmgr_ValidateDatasetName():
        old_part_number: int
        old_rev_name: int
        new_part_number: int
        new_rev_name: int
        new_part_type: int
        new_dataset_name: int
        valid: bool
        ifail: int
    

    class UFUgmgr_SaveasDatasetName():
        old_owner: int
        old_owner_revision: int
        old_dataset: int
        relation_type: int
        new_owner: int
        new_owner_revision: int
        dataset_name_modifiable: bool
        dataset_name: bytes
        ifail: int
    

    class UFUgmgr_SaveasDatasetInfo():
        old_part_number: int
        old_rev_name: int
        new_part_number: int
        new_rev_name: int
    ...
    class UFUgmgr_NewAlternatePartNo():
        part_tag: Tag
        context: int
        id_type: int
        alt_item_id: bytes
...
class UFUgfont(Utilities.NXRemotableObject):
    ...
    def AskFontHeader(self, fte: Tag, font: int, header: UF.UFUgfont.FontHeader) -> None:
        ...
    def AskFontName(self, fte: Tag, index: int, font_name: str) -> None:
        ...
...
class UFSubdiv(Utilities.NXRemotableObject):
    ...
    class UFSubdiv_DataStructuresUnion():
        subdiv_type1: int
...
class UFStudio(Utilities.NXRemotableObject):
    ...
    class UFStudio_StybldData():
        ...
        curve1: int
        curve2: int
        curve_trans1: UF.UFStudio._StybldCurveTrans
        curve_trans2: UF.UFStudio._StybldCurveTrans
        center_curve: int
        reverse_center_curve: bool
        center_as_spine: int
        start_extension: float
    ...
    class UFStudio_StybldCurveTrans():
        trans_type: UF.UFStudio.StybldTrans
        start: int
        end: int
        peak: int
...
class UFSmd(Utilities.NXRemotableObject):
    ...
    class UFSmd_FormOutput():
        process_name: int
        process_type: int
        description: int
    

    class UFSmd_ChkStdResults():
        num_objects: int
        results: int
...
class UFSf(Utilities.NXRemotableObject):
    ...
    class NeutralMaterialTypes(enum.Enum):
        ...
        MaterialCuring = 33
        MaterialPorous = 35
        MaterialCompoundisotropic = 36
        MaterialLowdensityfoam = 37
        MaterialFabric = 38
        MaterialCrushablefoam = 39
        MaterialRatesensitivefoam = 40
        MaterialMultimechmicrostructure = 41
        MaterialHoneycomb = 42
        MaterialComposite = 43
    ...
    class UFSf_MeshErrorList():
        num_mesh_errors: int
        mesh_errors: int
    

    class UFSf_MeshErrorContainer():
        node_asso_error_list: UF.UFSf.MeshErrorList
        elem_asso_error_list: UF.UFSf.MeshErrorList
        mesh_asso_error_list: UF.UFSf.MeshErrorList
        mesh_recipe_error_list: UF.UFSf.MeshErrorList
...
class UFRoute(Utilities.NXRemotableObject):
    ...
    class UFRoute_TagList():
        num_alloc: int
        num_used: int
        array: Tag
    

    class UFRoute_CharDesc():
        name: int
        type: int
    

    class UFRoute_AppViewDesc():
        name: int
        filename: int
...
class UFPlist(Utilities.NXRemotableObject):
    ...
    class UFPlist_Prefs():
        section_prefs: UF.UFTabnot._SectionPrefs
        grow_direction: UF.UFPlist.GrowDirection
        ldr_method: UF.UFPlist.LdrMethod
        create_new_rows_as_locked: bool
        initial_callout_field: int
        callout_increment: int
        symbol_type: UF.UFPlist.SymbolType
        main_symbol_text: int
        ref_symbol_text: int
        characters_to_skip: int
        auto_update: bool
        sort_on_update: bool
        highlight_manual_text: bool
        isProtected: bool
    ...
    class UFPlist_ColPrefs():
        is_key_field: bool
        default_string: int
        cell_prefs: UF.UFTabnot._CellPrefs
        is_protected: bool
...
class UFPd(Utilities.NXRemotableObject):
    ...
    class UFPd_ProductDefinition():
        name: int
        geometry_references: Tag
        num_geometry_references: int
        retained: bool
    ...
    class UFPd_ProductAttribute2():
        attribute_type: UF.UFPd.AttributeType
        attribute_group: int
        attribute_type_name: int
        attribute_name: int
        symbolic_display: int
        kf_name: int
        number_busmods: int
        busmods: int
        values: int
    ...
    class UFPd_BusinessModifier():
        title: int
        value: int
    

    class UFPd_AttributeValueString():
        num_strings: int
        strings: int
    

    class UFPd_AttributeValueData2():
        title: int
        dat: int
    

    class UFPd_AttributeValueData():
        title: int
        dat: UF.UFPd._AttributeValueString
    

    class UFPd_AttributeValue():
        value_type: UF.UFPd.AttributeValueType
        value_title: int
        integer_value: int
        number_value: float
...
class UFPart(Utilities.NXRemotableObject):
    ...
    def SetStatus(self, part_tag: Tag, status: int) -> None:
        ...
    def TranslateJt(self, part: Tag, config_file: str, output_dir: str) -> None:
        ...
...
class UFMotion(Utilities.NXRemotableObject):
    ...
    class UFMotion_VectorForceTorque():
        name: bytes
        vtype: UF.UFMotion.VectorType
        link: Tag
        origin: Tag
    ...
    class UFMotion_ScalarForceTorque():
        name: bytes
        attach_body: Tag
        origin_1: Tag
        origin_2: Tag
    ...
    class UFMotion_PointOnSurfaceData():
        point_on_surface_tag: Tag
        point_tag: Tag
        point_link_tag: Tag
        num_face_tags: int
    ...
    class UFMotion_PointCurveConstraint():
        name: bytes
        num_curve_tags: int
        curve: Tag
        point: Tag
    ...
    class UFMotion_Function():
        name: int
        definition: int
        num_lines: int
    

    class UFMotion_CylindricalBushing():
        name: bytes
        link_1: Tag
        origin_1: Tag
        direction_1: Tag
    ...
    class UFMotion_CurveCurveConstraint():
        name: bytes
        num_curve_1_tags: int
        curve_1: Tag
        num_curve_2_tags: int
...
class UFModlTrex(Utilities.NXRemotableObject):
    ...
    class UFModlTrex_ApplData():
        num_targets: int
        num_tools: int
        extend_method: UF.UFModlTrex.ExtendMethod
        to_option: UF.UFModlTrex.ToOption
        region_option: UF.UFModlTrex.RegionOption
        make_corner: int
        keep_boundaries: int
        extract_sheets: int
        dist_tol: float
...
class UFModl(Utilities.NXRemotableObject):
    ...
    def AskAngleTolerance(self, tolerance: float) -> None:
        """[Obsolete("Deprecated")"""
        ...
    def AskAngleToleranceOfPart(self, object_in_part: Tag, tolerance: float) -> None:
        ...
    ...
    def AskDistanceTolerance(self, tolerance: float) -> None:
        """[Obsolete("Deprecated")"""
        ...
    def AskDistanceToleranceOfPart(self, object_in_part: Tag, tolerance: float) -> None:
        ...
    ...
    def MoveFeature(self, cmtag: typing.List[Tag], mode: int, real_data: float) -> None:
        ...
    def MswpAskExtrude(self, feature: Tag, extrude: UF.UFModl.MswpExtrude) -> None:
        ...
    def MswpCreateExtrude(self, extrude: UF.UFModl.MswpExtrude, num_features: int, features: typing.List[Tag]) -> None:
        ...
    def MswpEditExtrude(self, feature: Tag, extrude: UF.UFModl.MswpExtrude) -> None:
        ...
    def MswpInitExtrudeData(self, extrude: UF.UFModl.MswpExtrude) -> None:
        ...
    ...
    def SetAngleTolerance(self, tolerance: float) -> None:
        """[Obsolete("Deprecated")"""
        ...
    def SetAngleToleranceOfPart(self, object_in_part: Tag, tolerance: float) -> None:
        ...
    ...
    def SetDistanceTolerance(self, tolerance: float) -> None:
        """[Obsolete("Deprecated")"""
        ...
    def SetDistanceToleranceOfPart(self, object_in_part: Tag, tolerance: float) -> None:
        ...
    ...
    class UFModlMswpUntilSelectedData():
        selected_object: Tag
    

    class MswpTaperType(enum.Enum):
        MswpTaperNone = 0
        MswpTaperFromEdge = 1
        MswpTaperFromProfile = 2
        MswpTaperSymmetry = 3
        MswpTaperMatched = 4
        MswpTaperAsymmetric = 5
    

    class UFModlMswpTaperChain():
        angle: UF.UFModl.MswpStringData
        back_angle: UF.UFModl.MswpStringData
        num_curves: int
        curves: typing.List[Tag]
    

    class UFModlMswpTaper():
        type: UF.UFModl.MswpTaperType
        angle: UF.UFModl.MswpStringData
        back_angle: UF.UFModl.MswpStringData
        multi_taper: UF.UFModl.MswpMultiTaper
    

    class UFModlMswpStringData():
        _string: str
        expression_tag: Tag
    

    class MswpOffsetType(enum.Enum):
        MswpOffsetNone = 0
        MswpOffsetNormal = 1
        MswpOffsetSymmetry = 2
        MswpOffsetSingle = 3
    

    class UFModlMswpOffsets():
        type: UF.UFModl.MswpOffsetType
        start_offset: UF.UFModl.MswpStringData
        end_offset: UF.UFModl.MswpStringData
    

    class UFModlMswpMultiTaper():
        num_chains: int
        chains: typing.List[UF.UFModl.MswpTaperChain]
    

    class MswpLimitType(enum.Enum):
        MswpLimitDistance = 0
        MswpLimitUntilNext = 1
        MswpLimitUntilSelected = 2
        MswpLimitThruAll = 3
        MswpLimitOffsetFromSelected = 4
    

    class UFModlMswpLimits():
        symmetry: bool
        start_limit: UF.UFModl.MswpLimit
        end_limit: UF.UFModl.MswpLimit
    

    class UFModlMswpLimitDataU():
        distance_data: UF.UFModl.MswpStringData
        until_selected_data: UF.UFModl.MswpUntilSelectedData
    

    class UFModlMswpLimit():
        limit_type: UF.UFModl.MswpLimitType
        limit_data: UF.UFModl.MswpLimitDataU
        surf_extend: bool
        end_limit_from_start: int
    

    class UFModlMswpExtrude():
        section: Tag
        direction: Tag
        dist_tol: float
        chain_tol: float
        planar_tol: float
        angle_tol: float
        limits: UF.UFModl.MswpLimits
        offsets: UF.UFModl.MswpOffsets
        taper: UF.UFModl.MswpTaper
        sign: UF.FeatureSigns
        target_body: Tag
        heal_geom: int
        solid_preferred: bool
        allow_self_intersecting_section: bool
        openProfileSmartVolume: bool
        closeProfileRule: int
        treatBsplineAsPline: int
    ...
    class UFModl_UdfExpData():
        num_exps: int
        old_exps: Tag
        new_exp_values: int
    

    class UFModl_SymbThreadData():
        cyl_face: Tag
        start_face: Tag
        axis_direction: float
        include_instances: int
    ...
    class UFModl_StyledSweepData():
        num_section: int
        guide: int
        touch: int
        spine: int
        spine_vector: Tag
        move_string_data: int
        auto_init_orient: int
    

    class UFModl_StycornerData():
        blend_faces: typing.List[Tag]
        num_base_faces: int
        base_faces: Tag
        split_curve_params: float
    ...
    class UFModl_SnipsrfFeatureData():
        edit_face: Tag
        boundary_type: UF.UFModl.SnipsurfBoundaryType
        snip_cv_string: UF.StringList
        snipping_plane: Tag
    ...
    class UFModl_SmreliefData():
        base_face: Tag
        first_corner_edges: typing.List[Tag]
        second_corner_edges: typing.List[Tag]
        offset_corner: float
        first_corner_fillet_radius: int
        second_corner_fillet_radius: int
        os_circle_radius: int
        offset_distance: int
    

    class UFModl_SmpunchData():
        punch_type: UF.UFModl.PunchType
        top_type: UF.UFModl.SmpunchTopType
        proj_method: UF.UFModl.SmholeDirectionType
        tool_center: Tag
    ...
    class UFModl_SmpunchCutSets():
        num_curves: int
        curves: Tag
    

    class UFModl_SmjoggleData():
        base_face: Tag
        ref_face1: Tag
        ref_face2: Tag
        trans_start_edge: Tag
        ...
        edge_to_edge: bool
        mat_thickness: int
        bend_allowance_formula: int
    

    class UFModl_SmholeData():
        diameter: bytes
        depth: bytes
        tip_angle: bytes
        edge1: Tag
    ...
    class UFModl_SmbendCylinderData():
        base_face: Tag
        stat_side: UF.UFModl.SmbendStatSide
        baf: bytes
    

    class UFModl_SmbendCornerData():
        base_edge: Tag
        radius: bytes
        radius_type: UF.UFModl.SmbendRadius
        stat_side: UF.UFModl.SmbendStatSide
    ...
    class UFModl_SimplData():
        ...
        boundary_edges: Tag
        n_non_boundary_edges: int
        non_boundary_edges: Tag
        n_imprint_features: int
        imprint_features: Tag
        max_hole_dia_expression: Tag
    

    class UFModl_ShapePatternClientDialogData():
        PartName: int
        HoleName: int
        iCountRecommendedShape: int
        RecommendedShapeNames: int
        RecommendedShapeThumbnailImageNames: int
        RecommendedShapeLargeImageNames: int
        iCountOtherShape: int
        OtherShapeNames: int
        OtherShapeThumbnailImageNames: int
        OtherShapeLargeImageNames: int
        NoImageBmpName: int
        CurrentHoleShapePatternName: int
        CurrentLargeImageName: int
        iSelectedHoleShapeIndex: int
        bSelFromRecommendedGroup: bool
    

    class UFModl_SflangeData():
        type: UF.UFModl.SflangeType
        dir_opt: UF.UFModl.SflangeDir
        trim_opt: UF.UFModl.SflangeTrim
        base_cont: UF.UFModl.SflangeContinuity
    ...
    class UFModl_RoughOffset():
        entities: Tag
        num_entities: int
        smart_csys: Tag
        offset_distance: bytes
        offset_deviation: bytes
        stepover_distance: bytes
        surf_method: UF.RsoSurfMethod
        surf_ctrl_type: UF.RsoSurfCtrlOption
        u_patches: int
        boundary_trim: UF.RsoTrimOption
    ...
    class UFModl_RefitFaceTargetData():
        n_target_obj: int
        target_obj: Tag
        fit_direction_data: UF.UFModl.RefitFaceFitDirection
        max_checking_data: float
    ...
    class UFModl_ReblendFaceData():
        num_chains: int
        radius: bytes
        chain_data: int
    

    class UFModl_ReblendFace():
        chained: bool
        n_faces: int
        faces_eid: Tag
    

    class UFModl_MswpTaperChain():
        angle: UF.UFModl._MswpStringData
        back_angle: UF.UFModl._MswpStringData
        num_curves: int
        curves: Tag
    

    class UFModl_MswpTaper():
        type: UF.UFModl.MswpTaperType
        angle: UF.UFModl._MswpStringData
        back_angle: UF.UFModl._MswpStringData
        multi_taper: UF.UFModl.MswpMultiTaper
    ...
    class UFModl_MswpStringData():
        _string: bytes
        expression_tag: Tag
    

    class UFModl_MswpOffsets():
        type: UF.UFModl.MswpOffsetType
        start_offset: UF.UFModl._MswpStringData
        end_offset: UF.UFModl._MswpStringData
    

    class UFModl_MswpMultiTaper():
        num_chains: int
        chains: int
    

    class UFModl_MswpLimits():
        symmetry: bool
        start_limit: UF.UFModl.MswpLimit
        end_limit: UF.UFModl.MswpLimit
    

    class UFModl_MswpLimitDataU():
        distance_data: UF.UFModl._MswpStringData
        until_selected_data: UF.UFModl.MswpUntilSelectedData
    

    class UFModl_MswpLimit():
        limit_type: UF.UFModl.MswpLimitType
        limit_data: UF.UFModl.MswpLimitDataU
        surf_extend: bool
        end_limit_from_start: int
    ...
    class UFModl_MatchedgeData():
        edit_edge_tag: Tag
        match_target_type: int
        match_continuity: int
        match_dir_vector_tag: Tag
        count_of_targets: int
        target_entity_tags: Tag
        flow_control: int
        adjacent_vec: float
        side_lock: int
        opposite_lock: int
    ...
    class UFModl_ImprintFacesData():
        n_imprint_faces: int
        imprint_faces: Tag
        imprint_datum_plane: Tag
    

    class UFModl_FlangeData():
        angle_type: int
        length_type: int
        radius_type: int
        ltaper_type: int
    ...
    class UFModl_EdgeBlendStopshortData():
        edge: Tag
        from_start: bool
        distance: bytes
        distance_exp: Tag
    ...
    class UFModl_EdgeBlendSetbackData():
        edge: Tag
        from_start: bool
        distance: bytes
        distance_exp: Tag
    ...
    class UFModl_EdgeBlendMultData():
        blend_instanced: bool
        vrb_tolerance: float
        smooth_overflow: bool
        cliff_overflow: bool
        notch_overflow: bool
        allow_twist_patches: bool
        soften_vertices: bool
        num_sets: int
        num_var_rad: int
        var_edges: Tag
        var_radius_data: int
    ...
    class UFModl_DieTipInfo():
        product: Tag
        origin: float
        center: float
        defining_tip_feature: Tag
        trans: float
        num_trans_reasons: int
        trans_reasons: int
        num_steps: int
        rot_axis: int
        rot_angle: float
    ...
    class UFModl_DeviationCheckData():
        number_of_points_checked: int
        minimum_distance_error: float
        maximum_distance_error: float
        average_distance_error: float
    ...
    class UFModl_ComparePartMapData3():
        part1: int
        part2: int
        identical_parts: bool
    

    class UFModl_ComparePartMapData():
        part1: UF.UFModl.ComparePartEntitiesData
        part2: UF.UFModl.ComparePartEntitiesData
        identical_parts: bool
    

    class UFModl_ComparePartEntitiesData3():
        edges: int
        faces: int
        features: int
        expressions: int
    ...
    class UFModl_ComparePartEntitiesData():
        edges: UF.UFModl.CompareEntityInfo
        faces: UF.UFModl.CompareEntityInfo
        features: UF.UFModl.CompareEntityInfo
        expressions: UF.UFModl.CompareEntityInfo
    ...
    class UFModl_CompareEntityInfo():
        num_entities: int
        entity_info: int
    

    class UFModl_BsurfRowInfo():
        num_points: int
        points: float
        weight: float
    

    class UFModl_Bsurface():
        num_poles_u: int
        num_poles_v: int
        order_u: int
        order_v: int
    ...
    class UFModl_BlendPoint():
        radius: bytes
        parameter: float
    

    class UFModl_BlendFacesCreateData():
        first_set: Tag
        first_set_size: int
        flip_first_normal: bool
        second_set: Tag
    ...
    class UFModl_BlendEdge():
        edge: Tag
        cliff_edge: Tag
        number_points: int
        start_setback_dis: bytes
        end_setback_dis: bytes
        point_data: int
    

    class UFModl_BendOperationData():
        operation_type: UF.UFModl.BendOperationE
        bend_edge: Tag
        bend_face: Tag
        use_adjacent_bend_face: bool
...
class UFKf(Utilities.NXRemotableObject):
    ...
    def AskListItem(self, list: int, index: int, value: int) -> None:
        ...
    def AskListItemValue(self, list_obj: int, list_index: int, value_str: str, datatype: str, unit: str, measure: str, sub_list_obj: int) -> None:
        ...
    ...
    def AskNumber(self, value: int, data: float) -> None:
        ...
    def AskNumberWithMeasure(self, value: int, data: float, measure: str) -> None:
        ...
    def AskNumberWithUnit(self, value: int, data: float, unit: str) -> None:
        ...
    ...
    def AskVector(self, value: int, data: float) -> None:
        ...
    def ConvertToDegreeBase(self, data: float, measure: str, data_converted: float) -> None:
        ...
    def ConvertToRadianBase(self, data: float, measure: str, data_converted: float) -> None:
        ...
    ...
    def MakeNumber(self, data: float, value: int) -> None:
        ...
    def MakeNumberWithMeasure(self, data: float, measure: str, value: int) -> None:
        ...
    def MakeNumberWithUnit(self, data: float, unit: str, value: int) -> None:
        ...
...
class UFGdt(Utilities.NXRemotableObject):
    ...
    class UFGdt_ThreadTolerance():
        thread_tol: int
        modifier_data: int
    

    class UFGdt_ThreadData():
        pitch_dia_grade: int
        pitch_dia_deviation: int
        grade: int
        deviation: int
        thread_class: int
    

    class UFGdt_TargetUdefArea():
        datum_feature: Tag
        target_index: int
        curves: Tag
        num_curves: int
    ...
    class UFGdt_SurfaceParms():
        num_faces: int
        faces: Tag
    

    class UFGdt_StatisticalInfo():
        other_statistical_data: int
    

    class UFGdt_SizeTolerance():
        value_type: UF.UFGdt.SizeValueType
        dimension: Tag
        nominal_value: float
        upper_tol: UF.UFGdt.ToleranceValue
    ...
    class UFGdt_ProductAttribute():
        num_attributes: int
        attributes: int
    

    class UFGdt_MultipleDatum():
        num_datums: int
        datum_features: Tag
        def_feat: Tag
    

    class UFGdt_ModlData():
        num_modl_features: int
        modl_feature_list: Tag
        modl_param: UF.UFGdt.ModlParameter
        face_map: Tag
    

    class UFGdt_ModifierData():
        num_modifiers: int
        modifier_types: typing.List[UF.UFGdt.ModifierTypes]
        proj_zone: int
        unit_length: int
    ...
    class UFGdt_LimitsAndFitsTolerance():
        limits_and_fits_data: int
        plus_minus_data: int
    

    class UFGdt_LimitsAndFitsData():
        deviation: int
        fit_type: int
        fit_grade: int
        tol_grade: int
    ...
    class UFGdt_FeatureParms():
        num_faces: int
        face_list: Tag
        descript: int
        feature: UF.UFGdt.FeatureType
        pattern: UF.UFGdt.PatternType
        modifier_data: int
        num_sets: int
        def: UF.UFGdt.GeometricDefinition
        num_modl_sets: int
    ...
    class UFGdt_DirectedDimension1():
        type: UF.UFGdt.DirectedDimensionType
        size_data: int
        origin: Tag
        origin_surfs: int
    ...
    class UFGdt_Description():
        name: int
        description: int
    

    class UFGdt_DatumIdentifier():
        datum_label: int
        def_feat: Tag
        is_individual: bool
    

    class UFGdt_DataFrame():
        tolerance_zone: int
        primary: int
        secondary: int
        tertiary: int
    ...
    class UFGdt_CalloutString():
        tolerance: Tag
        type: UF.UFGdt.ToleranceType
        _string: int
    

    class UFGdt_AnnotationTags():
        dimension_tags: Tag
        num_dimension_tags: int
        feature_control_frame_tags: Tag
        num_feature_control_frame_tags: int
        appended_text_tags: Tag
        num_appended_text_tags: int
        num_non_dimensional_leaders: int
...
class UFFam(Utilities.NXRemotableObject):
    ...
    class UFFam_MemberData():
        value_count: int
        values: int
    

    class UFFam_IntentData():
        family: Tag
        member_index: int
        attribute_count: int
        attributes: Tag
...
class UFFacet(Utilities.NXRemotableObject):
    ...
    def AskEdgeConvexity(self, model: Tag, facet_id: int, edge_in_facet: int, convexity: int) -> None:
        ...
    def AskErrorsDuringTessellation(self, tessellation: int, errors: typing.List[UF.UFFacet.TessellationError], error_count: int) -> None:
        ...
    ...
    def AskFaceIdOfSolidFace(self, model: Tag, face_tag: Tag, face_id: int) -> None:
        ...
    def AskFaceOfTessellation(self, tessellation: int, face_tag: Tag) -> None:
        ...
    def AskFacetDataOfTessellation(self, tessellation: int, facetID: int, vertices: float, vertex_normals: float) -> None:
        ...
    ...
    def AskNumFacetsInFace(self, model: Tag, face_id: int, num_facets: int) -> None:
        ...
    def AskNumFacetsInTessellation(self, tessellation: int, count: int) -> None:
        ...
    ...
    def DeleteAllFacetsFromModel(self, model: Tag) -> None:
        ...
    def DeleteTessellation(self, tessellation: int) -> None:
        ...
    ...
    def SetVertexOfFacet(self, model: Tag, facet_id: int, vertex_in_facet: int, location: float) -> None:
        ...
    def TessellateFace(self, face_tag: Tag, parameters: UF.UFFacet.TessellationParameters, tessellation: int) -> None:
        ...
    def UpdateModel(self, model: Tag, parameters: UF.UFFacet.Parameters) -> None:
        ...


    class UFFacetTessellationParameters():
        specify_surface_dist_tolerance: bool
        surface_dist_tolerance: float
        specify_surface_angular_tolerance: bool
        surface_angular_tolerance: float
        specify_curve_dist_tolerance: bool
        curve_dist_tolerance: float
        specify_curve_angular_tolerance: bool
        curve_angular_tolerance: float
        specify_max_facet_size: bool
        max_facet_size: float
    

    class UFFacetTessellationError():
        code: int
        facet_id: int
        face_tag: Tag
...
class UFDrf(Utilities.NXRemotableObject):
    ...
    class UFDrf_WeldSymInfo():
        finish_type: UF.UFDrf.WeldFinishTypes
        contour_type: UF.UFDrf.WeldContourTypes
        weld_type: UF.UFDrf.WeldSymbolTypes
        size_code: UF.UFDrf.WeldSizeCode
        angle: bytes
        num_root_depth: bytes
        size: bytes
        pitch: bytes
    

    class UFDrf_WeldSymbols():
        sym_info_top: UF.UFDrf._WeldSymInfo
        sym_info_bottom: UF.UFDrf._WeldSymInfo
        extension: UF.UFDrf.WeldSymExtType
        ident_line_type: UF.UFDrf.WeldIdentLineType
        peripheral_flag: int
        field_flag: int
        ...
        center_flag: int
        num_lines: int
        symbol_standard: bytes
        reference_text: int
        scale_factor: float
    

    class UFDrf_UdSymbolFontInfo():
        anchor_point: int
        orientation_point: int
        factor: float
        length: float
    ...
    class UFDrf_LeaderData():
        num_leaders: int
        associativity_data: int
        leader_orientation: UF.UFDrf.LeaderOrientation
    ...
    class UFDrf_Leader():
        num_leaders: int
        leader_terminators: Tag
        leader_orientation: UF.UFDrf.LeaderOrientation
        intermediate_points: int
    

    class UFDrf_LabelInfo():
        num_text: int
        text_info: int
        num_leaders: int
        leader_info: int
    ...
    class UFDrf_IntermediatePoints():
        num_points: int
        points: float
    

    class UFDrf_ImageData():
        image_name: int
        drawing_sheet: Tag
        aspect_ratio_locked: bool
        width: float
    ...
    class UFDrf_HatchFillPreferences():
        hatch_distance: float
        hatch_angle: float
        hatch_tolerance: float
        hatch_file: bytes
        hatch_material: bytes
        area_fill_material: UF.UFDrf.AreaFillMaterial
        area_fill_scale: float
        area_fill_angle: float
        color: int
    ...
    class UFDrf_DimensionPreferences1():
        tolerance_type: UF.UFDrf.ToleranceType
        upper_tolerance_english: float
        lower_tolerance_english: float
        upper_tolerance_metric: float
        ...
        baseline_offset: float
        chain_offset: float
        narrow_dimension_data: int
        narrow_dimension_arrowhead_type: UF.UFDrf.ArrowheadAndFillType
        chamfer_dimension_data: int
        dim_inspection_type: UF.UFDrf.InspectionType
        dim_reference_type: UF.UFDrf.ReferenceSymbolType
        trim_dim_line: UF.UFDrf.TrimDimLineStyle
    

    class UFDrf_DimensionPreferences():
        tolerance_type: UF.UFDrf.ToleranceType
        upper_tolerance_english: float
        lower_tolerance_english: float
        upper_tolerance_metric: float
        ...
        narrow_dimension_data: UF.UFDrf.NarrowDimensionInfo
        narrow_dimension_arrowhead_type: UF.UFDrf.ArrowheadAndFillType
        chamfer_dimension_data: UF.UFDrf._ChamferDimensionData
        dim_inspection_type: UF.UFDrf.InspectionType
        dim_reference_type: UF.UFDrf.ReferenceSymbolType
        trim_dim_line: UF.UFDrf.TrimDimLineStyle
    

    class UFDrf_DiameterRadiusPreferences():
        diameter_symbol_type: UF.UFDrf.DiameterSymbol
        diameter_symbol: bytes
        radius_symbol_type: UF.UFDrf.RadiusSymbol
        radius_symbol: bytes
        diameter_radius_placement: UF.UFDrf.DiameterRadiusPlacement
        text_above_leader: UF.UFDrf.TextAboveLeader
    ...
    class UFDrf_CustomSymbolText():
        ...
        max_value: float
        current_value: float
        optional_strings: int
        num_optional_strings: int
        current_option: int
        simple_text: int
    

    class UFDrf_CustomSymbol():
        geometry: Tag
        num_geometry: int
        text: int
        num_text: int
    ...
    class UFDrf_ChamferDimensionData():
        form: UF.UFDrf.ChamferDimensionForm
        stub_type: UF.UFDrf.ChamferDimensionStubType
        leader_type: UF.UFDrf.ChamferDimensionLeaderType
        symbol_type: UF.UFDrf.ChamferDimensionSymbolType
    ...
    class UFDrf_AssortpartLine():
        num_lines: int
        num_line_segments: int
        line_data: float
    

    class UFDrf_AssortpartArrow():
        num_arrows: int
        arrowhead_subtype: int
        arrow_data: float
    

    class UFDrf_AssortpartArc():
        num_arcs: int
        num_arc_segments: int
        arc_data: float
...
class UFDraw(Utilities.NXRemotableObject):
    ...
    class UFDraw_ViewLabelParms():
        ...
        view_label_customize: bool
        scale_parentheses: bool
        view_label_prefix: bytes
        scale_label_prefix: bytes
        view_letter: bytes
        parent_label_type: UF.UFDraw.LabelOnParentType
        text_to_gap_factor: float
        parent_vw_lbl_prefix: bytes
        show_rotation_symbol: bool
        show_rotation_angle: bool
        secondary_indexing_align: UF.UFDraw.SecondaryIndexingAlign
        subscript_size_factor: float
    ...
    class UFDraw_ViewInfo():
        ...
        inherit_pmi: bool
        model_name: bytes
        arrangement_name: bytes
    

    class UFDraw_ViewBoundary():
        curve_tag: Tag
        const_status: bool
        point_count: int
        defining_points: Tag
    ...
    class UFDraw_TabnotCellEvalData():
        text_position: float
        eval_text: int
    

    class UFDraw_SxlineSxsegs():
        sxseg_type: UF.UFDraw.SxsegType
        sxseg_object: int
        sxseg_angle: float
    

    class UFDraw_HalfSxsegs():
        bend_object: int
        cut_object: int
        arrow_object: int
    

    class UFDraw_BreakoutData1():
        base_point: Tag
        extrusion_vector: Tag
        num_curves: int
        curves: Tag
...
class UFDisp(Utilities.NXRemotableObject):
    ...
    class UFDisp_SrfanlData():
        ...
        refl_move_position: int
        refl_smooth_lines: int
        refl_user_image_filename: bytes
        num_contours: int
        surf_anal_display: int
        legend_color_type_gaussian: int
        legend_color_num_gaussian: int
...
class UFCutter(Utilities.NXRemotableObject):
    ...
    class UFCutter_TurnTrackingPointData():
        tlangl: float
        radius: float
        xoff: float
        yoff: float
    ...
    class UFCutter_TrackingPointData():
        diameter: float
        distance: float
        zoff: float
        adjust: int
...
class UFCutLevels(Utilities.NXRemotableObject):
    ...
    class UFCutLevels_CutLevelsStruct():
        num_levels: int
        cut_levels: int
        num_top_off_levels: int
        top_off_levels: int
...
class UFCurve(Utilities.NXRemotableObject):
    ...
    def CreatePoint(self, point_coords: float, point: Tag) -> None:
        ...
    def CreatePreciseOutline(self, solid_count: int, solid_array: typing.List[Tag], view: Tag, loop_count: int, count_array: int, curve_array: typing.List[Tag[]], tol: float) -> None:
        ...
    def CreatePreciseOutlineCurves(self, solid_count: int, solid_array: typing.List[Tag], view_tag: Tag, curve_count: int, outline_curves: typing.List[Tag]) -> None:
        ...
    ...
    class UFCurve_SectionPlanesData():
        planes: Tag
        num_planes: int
    

    class UFCurve_SectionGeneralData():
        objects: Tag
        num_objects: int
        associate: int
        grouping: int
    ...
    class UFCurve_OcfValues():
        _string: bytes
    

    class UFCurve_OcfStringData():
        string_tag: Tag
        offset_direction: int
        num_offsets: int
        offset_distances: int
    

    class UFCurve_OcfData():
        string_data: int
        num_string_data: int
        face_data: int
        cross_boundary_mode: UF.UFCurve.OcfCrossBoundaries
...
class UFClone(Utilities.NXRemotableObject):
    ...
    def AskAction(self, input_part_name: str, action_type: UF.UFClone.Action) -> None:
        ...
    def AskAssignDefaultProject(self, default_project: bool) -> None:
        ...
    ...
    def AskPdmName(self, input_part_name: str, pdm_name: str) -> None:
        ...
    def AskRetainOriginalOwnership(self, retain: bool) -> None:
        ...
    ...
    def SetAction(self, input_part_name: str, action_type: UF.UFClone.Action, replacement_part: str) -> None:
        ...
    def SetAssignDefaultProject(self, default_project: bool) -> None:
        ...
    ...
    def SetDryrun(self, dryrun: bool) -> None:
        ...
    def SetExcludeNgc(self, exclude: bool) -> None:
        ...
    def SetExcludeReferenceOnly(self, exclude: bool) -> None:
        ...
    def SetExportExternalFiles(self, ifExternExport: bool) -> None:
        ...
    ...
    def SetPropagateActions(self, propagate_actions: bool) -> None:
        ...
    def SetRetainOriginalOwnership(self, retain: bool) -> None:
        ...
    ...
    class UFClone_NameRuleDef():
        type: UF.UFClone.NameRuleType
        base_string: int
        new_string: int
    

    class UFClone_LogFileFailure():
        line_number: int
        input_part_name: int
        invalid_token: int
    

    class UFClone_CheckoutData():
        checkout: bool
        comment: int
...
class UFCgm(Utilities.NXRemotableObject):
    ...
    class UFCgm_WidthCustom():
        width: float
        name: bytes
    

    class UFCgm_CustomWidths():
        units: int
        use: UF.UFCgm.WidthUse
        single: UF.UFCgm.WidthSingle
        single_width: float
        single_source: int
        custom: typing.List[UF.UFCgm._WidthCustom]
        color: typing.List[UF.UFCgm.WidthColor]
    

    class UFCgm_CustomColors():
        colors: typing.List[UF.UFCgm._Color]
...
class UFAssem(Utilities.NXRemotableObject):
    ...
    def AddPartToAssembly(self, parent_part: Tag, part: str, refset_name: str, instance_name: str, origin: float, csys_matrix: float, layer: int, instance: Tag, error_status: UF.UFPart.LoadStatus) -> None:
        ...
    def AddPartToAssembly2(self, parent_part: Tag, part: str, refset_name: str, instance_name: str, origin: float, csys_matrix: float, layer: int, instance: Tag, error_status: UF.UFPart.LoadStatus) -> None:
        ...
    ...
    def AddSequencingView(self, view: Tag) -> None:
        ...
    def AddSnapshotMotionToSequence(self, snapshot_series_name: str, num_snapshots: int, num_occs: int, occs: Tag, snapshot_series_xforms: float, sequence: Tag, step_to_insert_after: Tag, snapshot_series: Tag) -> None:
        ...
    ...
    def RepositionInstance(self, instance: Tag, new_origin: float, new_csys_matrix: float) -> None:
        ...
    def RepositionInstance2(self, instance: Tag, new_origin: float, new_csys_matrix: float) -> None:
        ...
    ...
    class UFAssemOptions():
        ...
        managed_mode_variant_rule_option: int
    ...
    class UFAssem_InstanceIntent():
        fam_intent: int
    

    class UFAssem_DeformPartWarnings():
        num_warnings: int
        expressions_with_warnings: Tag
        warning_codes: int
        warning_strings: int
    

    class UFAssem_DeformPartData():
        convert_units_on_modified_parts: bool
        convert_units_on_read_only_modified_parts: bool
        part_occ_to_deform: Tag
        num_parents: int
        ...
        num_expressions: int
        old_expressions: Tag
        new_expression_values: int
        deformed_feature_tag: Tag
    

    class UFAssem_DeformedDefinitionData():
        part_occ: Tag
        parents: Tag
        parent_prompts: int
        num_parents: int
        expressions: Tag
        expression_prompts: int
        num_expressions: int
        help_string: int
    

    class UFAssem_DeformData():
        part_occ: Tag
        udfs_data: int
        help_url_string: int
...
class _SfLegendTitle():
    num_strs: int
    strs: int


class _SfLegendIndexTextAttr():
    attr_mask: int
    justify: UF.SfLegendTextJustification
    num_titles: int


class _SfLegendIndexColorAttr():
    attr_mask: int
    width_percent: int
    smooth_sw: bool
    num_values: int
...
class _SfLegendAttr():
    ...
    font_size: float
    font_color: int
    header: UF._SfLegendTitle
    index_attr: UF.SfLegendIndexAttr
    footer: UF._SfLegendTitle
    layout_type: int
    view_port_id: int
...
class _EplibPartLibPart():
    num_charx: int
    charx: int


class _EplibCharxValueU():
    i_value: int
    r_value: float
    s_value: int
