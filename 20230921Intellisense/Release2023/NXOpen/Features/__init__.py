...
class VDVMirrorBuilder(Features.FeatureBuilder):
    ...
    BezelCurve: Section
    Calotte: Expression
    CurvatureChange: Expression
    MirrorClass: Features.VDVMirrorBuilder.MirrorClasses
    MirrorFace: ScCollector
    MirrorFacetBodies: SelectNXObjectList
    MirrorLocation: Features.VDVMirrorBuilder.MirrorLocations
    MirrorRadius: Expression
    MirrorType: Features.VDVMirrorBuilder.MirrorTypes
    PivotPoint: Point
    PrimePoint: Point
...
class VDVCameraBuilder(Features.FeatureBuilder):
    ...
    CameraLensPoint: Point
    DefinitionType: Features.VDVCameraBuilder.DefinitionTypes
    FocalLength: Expression
    HorizontalAngle: Expression
    SensorHeight: Expression
    SensorWidth: Expression
    UpDirection: Direction
    VerticalAngle: Expression
...
class UserDefinedFeatureReferenceEditData(TaggedObject):
    ...
    def GetMappingData(self) -> Features.UserDefinedFeatureReferenceMappingData:
        ...
    NewReference: TaggedObject
    OldReference: TaggedObject
...
class UnitCellEditorBuilder(Builder):
    ...
    KeepRods: bool
    RodDiameter: float
    RodItemList: GeometricUtilities.RodItemListBuilder
    ShowGrid: bool
    ShowPattern: bool
...
class TubeLatticeBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    EndCaps: Features.TubeLatticeBuilder.EndCapsType
    FalloffDistance: Expression
    GraphStructure: ScCollector
    NodeSize: Expression
    Resolution: Features.TubeLatticeBuilder.ResolutionType
    RodSize: Expression
...
class TopologyOptimizationFeature(Features.Feature):
    ...
    def CreateStudyFromJsonFile(self, fileNameAndPath: str) -> Features.TopologyOptimization.Study:
        ...
    PostManager: Features.TopologyOptimization.PostManager
    ActiveStudy: Features.TopologyOptimization.Study
    ActiveSubcase: Features.TopologyOptimization.Subcase
    DelayUpdate: bool
...
class ThreadBuilder(Features.FeatureBuilder):
    ...
    CylindricalFace: SelectDisplayableObject
    ExtendStart: bool
    HolePreference: Features.ThreadBuilder.HoleSizePreference
    IsInternalThread: bool
    MajorDiameter: float
    MajorDiameterExp: Expression
    MatchThreadSizeToCylinder: bool
    MinorDiameter: float
    MinorDiameterExp: Expression
    NumStarts: int
    Pitch: float
    PitchExp: Expression
    PitchMultiple: Expression
    RadialEngage: str
    ReverseThreadDirection: bool
    ShaftDiameter: float
    ShaftDiameterExp: Expression
    ShaftPreference: Features.ThreadBuilder.ShaftSizePreference
    SmartThread: bool
    StartObject: SelectDisplayableObject
    TapDrillDiameter: float
    TapDrillDiameterExp: Expression
    Tapered: bool
    TaperedValue: bool
    ThreadHandedness: Features.ThreadBuilder.Handedness
    ThreadInput: Features.ThreadBuilder.Input
    ThreadLength: Expression
    ThreadLimit: Features.ThreadBuilder.LimitOption
    ThreadMethod: str
    ThreadSize: str
    ThreadStandard: str
    ThreadType: Features.ThreadBuilder.Type
...
class TextureBuilder(Builder):
    def __init__(self) -> None: ...
    AllowRunningOverFaceBoundaries: bool
    ImageFile: str
    ImprintImageValue: Features.TextureBuilder.ImprintImageValues
    MakeMonochrome: bool
    MaximumOffset: Expression
    MeshResolution: Features.TextureBuilder.MeshResolutions
    OverallTranslucency: int
    PatternCountDirection1: int
    PatternCountDirection2: int
    PatternImage: bool
    ScaleToModel: bool
    ScaleUniform: bool
    SmoothEdge: bool
    Transformer: GeometricUtilities.TransformerData
    UseCase: Features.TextureBuilder.UseCases
...
class StyledCornerBuilder(Features.FeatureBuilder):
    ...
    def UpdateCornerData(self, inputFaceChanged: bool, resetToTriangleCorner: bool) -> None:
        ...
    BaseCurveFitData: GeometricUtilities.CurveFitData
    ...
    TrimCurveFitData: GeometricUtilities.CurveFitData
...
class StepBuilder(Features.FeatureBuilder):
    ...
    ChamferMethod: Features.StepBuilder.ChamferMethods
...
class ShipCollection(TaggedObjectCollection):
    ...
    def CreateShipAttributeHolder(self) -> Features.ShipDesign.ShipAttributeHolder:
        """[Obsolete("Deprecated in NX8.0.3.  Use NXOpen.Features.ShipCollection.CreateShipAttributeHolderWithFeature.")"""
        ...
...
class ShadowCurveBuilder(Features.ServiceOrientedFeatureCurveBuilder):
    def __init__(self) -> None: ...
    AccuracyType: Features.ShadowCurveBuilder.AccuracyTypes
    BeamDirection: Direction
    ClippingBody: ScCollector
    ClippingType: Features.ShadowCurveBuilder.ClippingTypes
    CurveLocationFaces: ScCollector
    CurveLocationPlane: Plane
    CurveLocationType: Features.ShadowCurveBuilder.CurveLocationTypes
    CurveSettings: GeometricUtilities.CurveSettings
    DistanceThreshold: float
    EnableShadowRange: bool
    HalfAngle: Expression
    LightSourceType: Features.ShadowCurveBuilder.LightSourceTypes
    MaskBodyProcessingTypes: Features.ShadowCurveBuilder.MaskBodyProcessingType
    MaskType: Features.ShadowCurveBuilder.MaskTypes
    MaskingBodies: ScCollector
    MaskingCurves: Section
    OptimizeCurveFlag: bool
    OriginPoint: Point
    RayDirection: Direction
    ShadowRangeOnPlane: Expression
    SphereDiameter: Expression
    UnassociativeMaskingBodiesFromAssembly: ScCollector
    UpVector: Direction
    VerticalHalfAngle: Expression
    WidthHalfAngle: Expression
...
class SelectionProgramPiercedByBuilder(Builder):
    def __init__(self) -> None: ...
    ProximityObject: SelectNXObject
...
class SelectionProgramMainBuilder(Builder):
    ...
    def RemoveProgramListItem(self, listBuilder: Features.SelectionProgramListItemBuilder) -> None:
        ...
    CollectionType: Features.SelectionProgramMainBuilder.CollectionTypes
    ProgramList: Features.SelectionProgramListItemBuilderList
    RejectedDomainEntities: SelectNXObjectList
    SelectBody: SelectBodyList
    SelectFeature: SelectNXObjectList
    SelectGroup: SelectGroupList
    SelectionIntent: Features.SelectionProgramMainBuilder.SelectionIntentTypes
...
class SelectionProgramListItemBuilder(TaggedObject):
    def __init__(self) -> None: ...
    AdjacentProximityBuilder: Features.SelectionProgramAdjacentBuilder
    BetweenProximityBuilder: Features.SelectionProgramBetweenBuilder
    ClosestProximityBuilder: Features.SelectionProgramClosestBuilder
    DirectionFromProximityBuilder: Features.SelectionProgramDirectionFromBuilder
    FarthestProximityBuilder: Features.SelectionProgramFarthestBuilder
    InstructionType: Features.SelectionProgramListItemBuilder.InstructionTypes
    IntersectedByProximityBuilder: Features.SelectionProgramIntersectedByBuilder
    PiercedByProximityBuilder: Features.SelectionProgramPiercedByBuilder
    Proximity: Features.SelectionProgramListItemBuilder.ProximityTypes
...
class SelectionProgramBetweenBuilder(Builder):
    def __init__(self) -> None: ...
    FindIntersectedObjects: bool
    FirstBoundingObject: SelectNXObject
    SecondBoundingObject: SelectNXObject


class SelectionProgramAdjacentBuilder(Builder):
    def __init__(self) -> None: ...
    AdjacentType: Features.SelectionProgramAdjacentBuilder.AdjacentTypes
...
class RodThicknessBuilder(Builder):
    ...
    BallDiameterField: Fields.ScalarFieldWrapper
    BallsOption: Features.RodThicknessBuilder.BallsOptions
    BlendFactor: Expression
    BulkFaces: ScCollector
    FactorToRodDiameter: Expression
    IncreaseBallThickness: bool
    IncreaseRodThickness: bool
    LatticeBodies: ScCollector
    MaxDistanceFromBulk: Expression
    MaxFactorForBallThickness: Expression
    MaxFactorForRodThickness: Expression
    ModifyBalls: bool
    ModifyOption: Features.RodThicknessBuilder.ModifyOptions
    ModifyRods: bool
    RodDiameter: Fields.ScalarFieldWrapper
...
class RevolveOutlineBuilder(Features.ServiceOrientedFeatureCurveBuilder):
    def __init__(self) -> None: ...
    AxisFace: SelectFace
    ExcludedFaces: ScCollector
    PlaneNormal: Direction
    ReverseSide: bool
    TargetBodies: ScCollector
...
class ResizePatternBuilder(Features.AdmBaseBuilder):
    ...
    PatternFaces: ScCollector
    SeedFaces: ScCollector
...
class ResizeHoleBuilder(Features.AdmBaseBuilder):
    ...
    def RemoveFlipHoleFace(self, face: Face) -> None:
        ...
    ApplyCounterSunkRelief: bool
    ApplyThreadedRelief: bool
    CounterBoreDepth: Expression
    CounterBoreDiameter: Expression
    CounterSinkAngle: Expression
    CounterSinkDiameter: Expression
    CountersunkReliefDepth: Expression
    DepthLimitation: Features.ResizeHoleBuilder.DepthLimit
    DepthOption: Features.ResizeHoleBuilder.DepthTo
    EntryChamfer: bool
    EntryChamferAngle: Expression
    EntryChamferOffset: Expression
    ExitChamfer: bool
    ExitChamferAngle: Expression
    ExitChamferOffset: Expression
    FaceToChange: Features.FaceRecognitionBuilder
    HoleDepth: Expression
    HoleDiameter: Expression
    HoleFaces: ScCollector
    HoleType: Features.ResizeHoleBuilder.Type
    NeckChamfer: bool
    NeckChamferAngle: Expression
    NeckChamferOffset: Expression
    TapDrillDiameter: Expression
    TaperAngle: Expression
    ThreadDepth: Expression
    ThreadHoleDiameter: Expression
    ThreadSize: str
    ThreadStandard: str
...
class ResizeBlendBuilder(Features.FeatureBuilder):
    ...
    def ResizeBlendOnMultibodies(self) -> None:
        ...
    BlendFace: ScCollector
    FaceRecognized: Features.FaceRecognitionBuilder
    Radius: Expression
...
class RadiateFaceBuilder(Features.FeatureBuilder):
    ...
    AxisSel: SelectFace
    Diameter: Expression
    DimensionType: Features.RadiateFaceBuilder.DimensionTypes
    Distance: Expression
    FaceChangeOverflowBehavior: GeometricUtilities.FaceChangeOverflowBehavior
    FaceToRadiate: Features.FaceRecognitionBuilder
    Radius: Expression
    Reference: SelectFace
    ReverseDirection: bool
...
class PunchThroughBuilder(Builder):
    ...
    AllowRunningOverFaceBoundaries: bool
    ImageFile: str
    ImprintImageValue: Features.PunchThroughBuilder.ImprintImageValues
    OverallTranslucency: int
    PatternCountDirection1: int
    PatternCountDirection2: int
    PatternImage: bool
...
class ObstructionBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    ObstructionBodySelect: ScCollector
...
class MorphMeshTwistBendData(Builder):
    ...
    FalloffPercentage: int
    Height: Expression
    LinearSegments: int
    MeshBodies: SelectNXObjectList
    PivotPointLocation: Expression
    Size: Expression
    Transformer: GeometricUtilities.TransformerData
    TwistAngle: Expression
    Type: Features.MorphMeshTwistBendData.Types
...
class MorphMeshTransformBuilder(Builder):
    ...
    FallOffFactor: float
    FallOffMethod: Features.MorphMeshTransformBuilder.FallOffMethodType
    FallOffObjects: Features.Subdivision.SelectCageObjectData
    FallOffPercentage: int
    MovementMethod: Features.MorphMeshTransformBuilder.MovementMethodType
    MovementPlane: Plane
    MovementVector: Direction
    ScalingMethod: Features.MorphMeshTransformBuilder.ScalingMethodType
    TransformationMethod: Features.MorphMeshTransformBuilder.TransformationMethodType
    Type: Features.MorphMeshTransformBuilder.TransformationObjectType
    WCSOption: Features.MorphMeshTransformBuilder.WCSOptionType
...
class MorphMeshCageBuilder(Builder):
    ...
    def UpdateMesh(self) -> None:
        ...
    CylinderCircularSegments: int
    CylinderLinearSegments: int
    Height: Expression
    HeightZ: Expression
    ...
    Size: Expression
    TorusCircularSegments: int
    TorusRadialSegments: int
    Transformer: GeometricUtilities.TransformerData
    TubeSegments: int
    TubeSize: Expression
    Type: Features.MorphMeshCageBuilder.Types
    WidthY: Expression
    XSegments: int
    YSegments: int
    ZSegments: int
...
class LinearDimensionBuilder(Features.DimensionBuilder):
    ...
    def SetFaceToMove(self, face: Face) -> None:
        ...
    ComponentToMove: SelectNXObjectList
...
class LatticeFeatureCollection(Utilities.NXRemotableObject):
    ...
    def CreateLatticeBuilder(self, lattice: Features.Lattice) -> Features.LatticeBuilder:
        """[Obsolete("Deprecated in NX1899.0.0.  Use NXOpen.Features.Lattice2 instead.")"""
        ...
    ...
    def CreateFilterLatticeBuilder(self) -> Features.FilterLatticeBuilder:
        """[Obsolete("Deprecated in NX1899.0.0.  Use NXOpen.Features.FilterLattice2 instead.")"""
        ...
    ...
    def CreateConnectLatticesBuilder(self, connectLattices: Features.ConnectLattices) -> Features.ConnectLatticesBuilder:
        """[Obsolete("Deprecated in NX1899.0.0.  Use NXOpen.Features.ConnectLattices2 instead.")"""
        ...
...
class LatticeBuilder(Features.FeatureBuilder):
    ...
    RemeshMode: Features.LatticeBuilder.FacetSizeType
    RemoveDanglingRods: bool
    RemoveDisconnectedRods: bool
    RemoveDisconnectedRods2: bool
    ReverseFaceDirection: bool
    RodDiameter: Expression
    SharpEdgesLockOption: Features.LatticeBuilder.SharpEdgesLockType
    SizeX: Expression
    SizeY: Expression
    SizeZ: Expression
    Source: Features.LatticeBuilder.BaseMeshType
    SplitCurve: Section
    TessellationFactor: float
    ThicknessType: Features.LatticeBuilder.ThicknessTypes
    UnitCell: GeometricUtilities.UnitCellBuilder
...
class Lattice2Builder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    AlignAtSplitCurve: bool
    AngularThreshold: float
    AverageFacetSize: Expression
    BallDiameter: Expression
    BallDiameterField: Fields.ScalarFieldWrapper
    BallsOption: Features.Lattice2Builder.BallsOptions
    BaseFace: ScCollector
    BlendFactor: Expression
    ...
    ContourPoint4: Point
    Csys: CoordinateSystem
    CurveAlignedList: GeometricUtilities.CurveAlignedListBuilder
    FactorToRodDiameter: Expression
    FilterToolFace: ScCollector
    IsRandom: bool
    LatticeType: Features.Lattice2Builder.LatticeTypes
    LatticeVersion: Features.Lattice2Builder.Version
    Layers: int
    LockAtBoundary: bool
    MaxDeviation: Expression
    MaxEdgeLength: Expression
    ...
    OrientationPoint1: Point
    OrientationPoint2: Point
    OutputType: Features.Lattice2Builder.OutputOption
    Parameterization: Features.Lattice2Builder.ParameterizationType
    PoreSize: Expression
    PushNodesUnderFace: bool
    RemeshMode: Features.Lattice2Builder.FacetSizeType
    RemoveDanglingRods: bool
    RemoveDisconnectedRods: bool
    RemoveDisconnectedRods2: bool
    ReverseFaceDirection: bool
    RodDiameter: Fields.ScalarFieldWrapper
    SharpEdgesLockOption: Features.Lattice2Builder.SharpEdgesLockType
    SnipAtBoundary: bool
    Source: Features.Lattice2Builder.BaseMeshType
    SpecifyLayers: bool
    SplitCurve: Section
    TessellationFactor: float
    ThicknessType: Features.Lattice2Builder.ThicknessTypes
    UnitCell: GeometricUtilities.UnitCellBuilder
    VoronoiItemList: GeometricUtilities.VoronoiItemListBuilder
    VoronoiRandomizationFactor: float
    VoronoiRandomizationFactorExpression: Expression
    VoronoiRodDiameter: Expression
    VoronoiUniform: bool
...
class InterceptionMirrorListItemBuilder(TaggedObject):
    ...
    def Validate(self) -> bool:
        ...
    AxisPair: Features.InterceptionMirrorListItemBuilder.AxisPairs
    Mirror: Features.SelectFeature
    MirrorOrientation: Features.InterceptionMirrorListItemBuilder.MirrorOrientations
    XRotation: Expression
    YRotation: Expression
    ZRotation: Expression
...
class InterceptionBuilder(Features.FeatureBuilder):
    ...
    def CreateInterceptionCameraListItemBuilder(self) -> Features.InterceptionCameraListItemBuilder:
        ...
    AllowDirectVisibility: bool
    BlindspotColor: NXColor
    CameraList: Features.InterceptionCameraListItemBuilderList
    DirectVision: Features.SelectFeature
    DistanceThreshold: float
    DistanceTolerance: float
    GridTarget: ScCollector
    InterceptionStandard: Features.InterceptionBuilder.InterceptionStandards
    InterceptionType: Features.InterceptionBuilder.InterceptionTypes
    MirrorList: Features.InterceptionMirrorListItemBuilderList
    Obstructions: Features.SelectFeatureList
    TargetPoint: Point
    UseViewDirection: bool
    ViewDirectionMethod: Features.InterceptionBuilder.ViewDirectionMethods
    ViewDirectionVector: Direction
...
class HolePackageBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    BooleanOperation: GeometricUtilities.BooleanOperation
    CounterboreDepthLimitOption: Features.HolePackageBuilder.CounterBoreDepthLimitOptions
    CounterboreDistanceFromSelectedTarget: SelectDisplayableObject
    CounterboreUntilSelectedTarget: SelectDisplayableObject
    CustomEndChamferAngle: Expression
    CustomEndChamferEnabled: bool
    CustomEndChamferOffset: Expression
    CustomNeckChamferAngle: Expression
    CustomNeckChamferEnabled: bool
    CustomNeckChamferOffset: Expression
    CustomReliefDepth: Expression
    CustomReliefEnabled: bool
    CustomStartChamferAngle: Expression
    CustomStartChamferEnabled: bool
    CustomStartChamferOffset: Expression
    ...
    GeneralDistanceFromSelected: Expression
    ...
    HoleSize: Features.HolePackageBuilder.Holesize
    HoleType: Features.HolePackageBuilder.Holetype
    MiddleHoleData: GeometricUtilities.MiddleHoleData
    NeckChamferEnabled: bool
    PitchMultiplier: Expression
    ProjectPointOntoTargetEnabled: bool
    ProjectionDirection: GeometricUtilities.ProjectionOptions
    RadialEngageOption: str
    RelateHoleDepthToThreadDepth: bool
    ...
    ScrewClearanceDistanceFromSelected: Expression
    ...
    TypeOfHole: Features.HolePackageBuilder.TypesOfHole
...
class HealSurfaceBuilder(Features.FeatureBuilder):
    ...
    AngTol: float
    AngularThreshold: float
    ContinuityType: Features.HealSurfaceBuilder.ContinuityTypes
    DisTol: float
    DistanceThreshold: Expression
    Edges: ScCollector
    MaxDiscontinuityLabelMethod: Features.HealSurfaceBuilder.MaxDiscontinuityLabelMethods
    SharpEdges: ScCollector
    SheetBodies: SelectDisplayableObjectList
    ToleranceMarkup: bool
    Type: Features.HealSurfaceBuilder.HealTypes
...
class GridTargetBuilder(Features.FeatureBuilder):
    ...
    def CreateOuterGroundContactPoint(self) -> Point:
        ...
    AngleIncrement: Expression
    BoundaryOffset: Expression
    DirectVision: Features.SelectFeature
    DisplayAngleValues: bool
    DriverSideForGrid: Features.GridTargetBuilder.GridDriverSide
    EndAngle: Expression
    EndRadius: Expression
    GridLocation: Features.GridTargetBuilder.GridLocations
    GridPosition: Features.GridTargetBuilder.GridPositions
    GridReferencePoint: Point
    GridType: Features.GridTargetBuilder.GridTypes
    GroundWidePoint: Point
    Loading: str
    RadLinesAngleIncrement: Expression
    RadiusIncrement: Expression
    ReferencePointMethod: Features.GridTargetBuilder.GridPointSelectionType
    ShowRadiatingLines: bool
    ShowRectangularBoundary: bool
    Standard: Features.GridTargetBuilder.GridStandards
    StartAngle: Expression
    StartDirection: Direction
    StartRadius: Expression
    TargetDistanceFar: Expression
    TargetDistanceInfinite: Expression
    TargetDistanceNear: Expression
    TargetDistanceRef: Features.GridTargetBuilder.TargetDistanceReferences
    TargetWidthFar: Expression
    TargetWidthInfinite: Expression
    TargetWidthNear: Expression
    UseLoadingSpecifiedStandard: bool
...
class FreeformCurveCollection(Utilities.NXRemotableObject):
    ...
    DrawShapeCollection: Features.DrawShapes.DrawShapeCollection
...
class FlatteningAndFormingBuilder(Features.FeatureBuilder):
    ...
    def GetDestinationFrame(self, manipulatorOrigin: Point3d, manipulatorMatrix: Matrix3x3) -> None:
        """[Obsolete("Deprecated in NX2007.0.0.  Use NXOpen.Features.FlatteningAndFormingBuilderEx instead.")"""
        ...
...
class FlatSolid(Features.Feature):
    ...
    class FlatSolid_ObjectDataCsys():
        flat_solid_object: Tag
        formed_body_object: Tag
...
class FitSurfaceBuilder(Features.FeatureBuilder):
    ...
    BodyTypePreference: Features.FitSurfaceBuilder.BodyType
    CoordinateSystem: CoordinateSystem
...
class FilterLatticeBuilder(Builder):
    ...
    FilterByAngle: bool
    FilterByLength: bool
    FilterDanglingRods: Features.FilterLatticeBuilder.FilterDanglingRodsType
    LatticeBodies: ScCollector
    MaximumRodLength: Expression
    MinimumAngle: Expression
    PrintPlaneNormal: Direction
...
class FilterLattice2Builder(Features.FeatureBuilder):
    ...
    FilterByAngle: bool
    FilterByLength: bool
    FilterDanglingRods: Features.FilterLattice2Builder.FilterDanglingRodsType
    LatticeBodies: ScCollector
    MaximumRodLength: Expression
    MinimumAngle: Expression
    PrintPlaneNormal: Direction
...
class FeatureCollection(TaggedObjectCollection):
    ...
    DetailFeatureCollection: Features.DetailFeatureCollection
    MorphMeshCollection: Features.MorphMeshCollection
    StructureDesignCollection: Features.StructureDesignCollection
    AECDesignCollection: Features.AECDesignCollection
    AVDACollection: Features.AVDACollection
...
class FaceRecognitionBuilder(TaggedObject):
    ...
    FaceCollector: ScCollector
    FindChamfers: bool
    FindGeneralClone: bool
    FindMinOffsetRatio: float
    OffsetEnabled: bool
    OrthoLockingMode: Features.FaceRecognitionBuilder.FindOrthoLockingMode
    ParallelEnabled: bool
    PatternEnabled: bool
    PerpendicularEnabled: bool
    ReferenceCoordinateSystem: GeometricUtilities.OrientXpressBuilder
    RelationFoundMethod: Features.FaceRecognitionBuilder.RelationMethod
    RelationScope: int
    SameEntryEnabled: bool
    SameEntrySurfaceEnabled: bool
    SameOrbitEnabled: bool
    ...
    class FaceRecognitionBuilderRelation():
        RelationTag: NXObject
        RelationType: ModlConstraint.RelationType
        def ToString(self) -> str:
            ...
...
class ExtrudeBuilder(Features.FeatureBuilder):
    ...
    Section: Section
    SmartVolumeProfile: GeometricUtilities.SmartVolumeProfileBuilder
    SmartVolumeProfile1: GeometricUtilities.SmartVolumeProfileBuilder
...
class DirectVisionBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    EyePoint: str
    EyePointType: Features.DirectVisionBuilder.VisionType
    EyeRotationDown: Expression
    EyeRotationLeft: Expression
    EyeRotationRight: Expression
    EyeRotationType: Features.DirectVisionBuilder.EyeRotationTypes
    EyeRotationUp: Expression
    Eyellipse: Features.SelectFeature
    HeadRotationLeft: Expression
    HeadRotationRight: Expression
    HeadTurnType: Features.DirectVisionBuilder.HeadTurnTypes
    Standard: str
    UseHeadTurnToggle: bool
    UserDefinedPoint: Point
...
class DeleteTextureObjectsData(Builder):
    def __init__(self) -> None: ...
    ObjectsToDelete: SelectNXObjectList
...
class ContourRibBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    HeightDim: Expression
    HeightDimensionType: Features.ContourRibBuilder.HeightLimit
    HeightFace: ScCollector
    ProjectDirection: GeometricUtilities.ProjectionOptions
...
class ConnectLatticesBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    Lattice1: ScCollector
    Lattice2: ScCollector
    MaxCheckingDistance: float
    OriginalBodyOption: Features.ConnectLatticesBuilder.OriginalBodyOptions
    RodDiameter: Expression
    RodSizeOption: Features.ConnectLatticesBuilder.RodsizeOptions
    RodsPerVertex: int
...
class ConnectLattices2Builder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    BallsAndBlendsOption: Features.ConnectLattices2Builder.BallsAndBlendsOptions
    Lattice1: ScCollector
    Lattice2: ScCollector
    MaxCheckingDistance: Expression
    RodDiameter: Expression
    RodSizeOption: Features.ConnectLattices2Builder.RodsizeOptions
    RodsPerVertex: int
    RodsPerVertexExpression: Expression
    TessellationFactor: float
    TessellationOption: Features.ConnectLattices2Builder.TessellationOptions
...
class CombinePatternBuilder(Features.FeatureBuilder):
    def __init__(self) -> None: ...
    LinearPatternDefinition: GeometricUtilities.PatternDefinition
    PatternDefinition: GeometricUtilities.PatternDefinition
    PatternType: Features.CombinePatternBuilder.PatternTypeEnum
...
class ClipLatticeBuilder(Features.FeatureBuilder):
    ...
    BooleanTool: GeometricUtilities.BooleanToolBuilder
    BoundaryBody: ScCollector
    BoundaryClip: Features.ClipLatticeBuilder.Clipping
    BoundaryType: Features.ClipLatticeBuilder.BoundaryOptions
    LatticeBodies: ScCollector
    LatticeClip: Features.ClipLatticeBuilder.LatticeClipOptions
...
class BooleanBuilder(Features.FeatureBuilder):
    ...
    ToolBodyCollector1: ScCollector
...
class BodyLatticeBuilder(Features.FeatureBuilder):
    ...
    OrientationPoint1: Point
    OrientationPoint2: Point
    Parameterization: Features.BodyLatticeBuilder.ParameterizationType
    ReverseFaceDirection: bool
    SplitCurve: Section
    Type: Features.BodyLatticeBuilder.Types
    UnitCell: GeometricUtilities.UnitCellBuilder
...
class ApexRangeChamferBuilder(Features.FeatureBuilder):
    ...
    def CreateEdgeManager(self) -> GeometricUtilities.ChamferEdgeManager:
        ...
    EdgeManager: GeometricUtilities.ChamferEdgeManager
    LengthLimitsList: GeometricUtilities.LengthLimitsListBuilder
    OffsetMethod: Features.ApexRangeChamferBuilder.JaChamferBuilderOffsetmethod
    Tolerance: float
...
class AdmBaseBuilder(Features.FeatureBuilder):
    ...
    def OnApplyPre(self) -> None:
        ...
    SolveOption: Features.AdmBaseBuilder.SolveOptionType
    UpdateMethod: Features.AdmBaseBuilder.UpdateMethodType
