...
class SubdivisionTubeBuilder(Builder):
    def __init__(self) -> None: ...
    CrossSection: int
    EndCaps: Features.Subdivision.SubdivisionTubeBuilder.EndCapsType
    FalloffDistance: Expression
    GraphStructureObject: Features.Subdivision.SelectCageObjectData
    NodeSize: Expression
    ...
    RodSize: Expression
    Size: Expression
    Type: Features.Subdivision.SubdivisionTubeBuilder.Types
...
class SubdivisionProjectCageBuilderEx(Builder):
    ...
    def OnTargetAxis(self) -> None:
        ...
    Mode: Features.Subdivision.SubdivisionProjectCageBuilderEx.ModeOptions
    ObjectsToProject: Features.Subdivision.SelectCageObjectData
    ProjectBothSides: bool
    ProjectionDirectionType: Features.Subdivision.SubdivisionProjectCageBuilderEx.ProjectionDirectionTypes
    ...
    TargetFaces: SelectDisplayableObjectList
    TargetPlane: Plane
    TargetType: Features.Subdivision.SubdivisionProjectCageBuilderEx.TargetTypes
    Type: Features.Subdivision.SubdivisionProjectCageBuilderEx.Types
...
class SubdivisionProjectCageBuilder(Builder):
    def __init__(self) -> None: ...
    def OnTargetPlane(self) -> None:
        """[Obsolete("Deprecated in NX1926.0.0.  Use NXOpen.Features.Subdivision.SubdivisionBodyCollection.CreateSubdivisionProjectCageBuilderEx instead")"""
        ...
    def OnTargetDynamicPlane(self) -> None:
        """[Obsolete("Deprecated in NX1926.0.0.  Use NXOpen.Features.Subdivision.SubdivisionBodyCollection.CreateSubdivisionProjectCageBuilderEx instead")"""
        ...
...
class SubdivisionBodyCollection(TaggedObjectCollection):
    ...
    def CreateSubdivisionProjectCageBuilder(self) -> Features.Subdivision.SubdivisionProjectCageBuilder:
        """[Obsolete("Deprecated in NX1953.0.0.  Use NXOpen.Features.Subdivision.SubdivisionBodyCollection.CreateSubdivisionProjectCageBuilderEx instead")"""
        ...
    ...
    def CreateImportSubdivisionGeometryBuilder(self) -> Features.Subdivision.ImportSubdivisionGeometryBuilder:
        """[Obsolete("Deprecated in NX1899.0.0.  Use NXOpen.WavefrontObjImporter instead")"""
        ...
    ...
    def CreateExportSubdivisionGeometryBuilder(self) -> Features.Subdivision.ExportSubdivisionGeometryBuilder:
        """[Obsolete("Deprecated in NX1899.0.0.  Use NXOpen.WavefrontObjCreator instead")"""
        ...
...
class SectionTubeData(Builder):
    ...
    class SectionTubeDataSelectionData():
        SnappedObject: NXObject
        IsSnapped: bool
        SnappedPosition: Point3d
...
class DrawCageData(Builder):
    ...
    def ResetStartPoint(self) -> None:
        ...
    CageManipulator: Features.Subdivision.CageManipulatorData
    FaceShape: Features.Subdivision.DrawCageData.FaceShapeType


    class DrawCageDataSelectionData():
        SnappedObject: NXObject
        SnappedPosition: Point3d
        IsInferringPaused: bool
        def ToString(self) -> str:
            ...
