...
class ThreeBendCornerBuilder(Features.FeatureBuilder):
    ...
    CutMethod: Features.SheetMetal.ThreeBendCornerBuilder.CutMethodTypes
    Diameter: Expression
...
class TabBuilder(Features.SheetMetal.SheetmetalBaseBuilder):
    ...
    MultiThicknessProperty: Features.SheetMetal.MultiThicknessBuilder
    Section: Section
...
class SheetMetalFromSolidBuilder(Features.SheetMetal.SheetmetalBaseBuilder):
    ...
    BendPropertiesList: Features.SheetMetal.SheetMetalFromSolidBendPropertiesBuilderList
    HideOriginal: bool
...
class NestingBuilder(Builder):
    ...
    def LoadInputsFromFile(self, filePath: str) -> Features.SheetMetal.NestingBuilder.InputFileLoadStatus:
        ...
    BestSolution: NestedSolution
    DesiredSolution: NestedSolution
...
class FlatSolidBuilder(Features.SheetMetal.SheetmetalBaseBuilder):
    ...
    AddedGeometry: Section
    Associative: bool
    AutoAssociateObjects: bool
    FixAtTimestamp: bool
    FlatBodyColor: int
    FlatBodyLayer: int
    InnerCornerTreatment: Features.SheetMetal.CornerTreatmentBuilder
    LayerSetting: Features.SheetMetal.FlatSolidBuilder.LayerSettingOption
...
class ExportFlatPatternBuilder(Builder):
    ...
    ExportLocation: Features.SheetMetal.ExportFlatPatternBuilder.ExportLocationOptions
...
class EdgeRipBuilder(Features.SheetMetal.SheetmetalBaseBuilder):
    ...
    BlendSharpCorners: bool
    EndCapShape: Features.SheetMetal.EdgeRipBuilder.EndCapShapeOptions
...
class ClosedCornerBuilder(Features.FeatureBuilder):
    ...
    CutMethod: Features.SheetMetal.ClosedCornerBuilder.CutMethodTypes
    Diameter: Expression
    Gap: Expression
    Length: Expression
    Length1: Expression
    Length2: Expression
    LimitEdge1: ScCollector
    LimitEdge2: ScCollector
    MiterCorner: bool
    Offset: Expression
    Origin: Features.SheetMetal.ClosedCornerBuilder.OriginTypes
    Overlap: Expression
    OverlapType: Features.SheetMetal.ClosedCornerBuilder.OverlapTypeOptions
    PunchRadius: Expression
...
class BridgeTransitionBuilder(Features.SheetMetal.SheetmetalBaseBuilder):
    ...
    EndEdge: SelectEdge
    EndEdgeLateralOffset: Expression
    ...
    StartEdge: SelectEdge
    StartEdgeLateralOffset: Expression
...
class AssociateObjectBuilder(Features.FeatureBuilder):
    ...
    def CreateAssociateObjectInputListItemBuilder(self) -> Features.SheetMetal.AssociateObjectInputListItemBuilder:
        ...
    InputList: Features.SheetMetal.AssociateObjectInputListItemBuilderList
