...
class SimplifyBuilder(Builder):
    ...
    ExcludeBodiesCollector: ScCollector
    ExcludeBodiesExceptions: SelectDisplayableObjectList
    ExcludeFacesCollector: ScCollector
    ExcludeFacesExceptions: SelectDisplayableObjectList
    IncludeBodiesCollector: ScCollector
    IncludeBodiesExceptions: SelectDisplayableObjectList
    IncludeFacesCollector: ScCollector
    IncludeFacesExceptions: SelectDisplayableObjectList
    MaximumBlendRadius: Expression
    MaximumHoleSize: Expression
    MinimumBodySize: Expression
    ObjectsToSimplify: SelectDisplayableObjectList
    ObjectsToSimplifyCollector: ScCollector
    RemoveInternalBodies: bool
    RemoveInternalVoids: bool
    SourceAssembly: Part
    UniteBodies: bool
    UseBlendRadius: bool
    UseBodySize: bool
...
class Explosion(NXObject):
    ...
    class ExplosionExplosionOptions():
        ForceInterferingComponentsApart: bool
        PreferConstraintsForDirection: bool
    ...
    class ExplosionBlockingOptions():
        SearchAdditionalDirections: bool
        CheckSmallInterferences: bool
        def ToString(self) -> str:
            ...
